...
impl RegisterBlock {
    ...
    #[doc = "0x100 - DMA Channel N Mapping to Param Set"]
    #[inline(always)]
    pub const fn dchmapn(&self) -> &Dchmapn {
        &self.dchmapn
    }
    ...
    #[doc = "0x800 - Memory Protect Fault Address"]
    #[inline(always)]
    pub const fn mpfar(&self) -> &Mpfar {
        &self.mpfar
    }
    #[doc = "0x804 - Memory Protect Fault Status"]
    #[inline(always)]
    pub const fn mpfsr(&self) -> &Mpfsr {
        &self.mpfsr
    }
    #[doc = "0x808 - Memory Protect Fault Command"]
    #[inline(always)]
    pub const fn mpfcr(&self) -> &Mpfcr {
        &self.mpfcr
    }
    #[doc = "0x80c - MP Permission Attribute for Global Regs"]
    #[inline(always)]
    pub const fn mppag(&self) -> &Mppag {
        &self.mppag
    }
    #[doc = "0x810 - MP Permission Attribute for DMA Region N starting from 0x810 to 0x82C total 8 regions"]
    #[inline(always)]
    pub const fn mppan(&self) -> &Mppan {
        &self.mppan
    }
...
pub mod cccfg;
#[doc = "DCHMAPN (rw) register accessor: DMA Channel N Mapping to Param Set\n\nYou can [`read`](crate::Reg::read) this register and get [`dchmapn::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dchmapn::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@dchmapn`]
module"]
#[doc(alias = "DCHMAPN")]
pub type Dchmapn = crate::Reg<dchmapn::DchmapnSpec>;
...
#[doc = "AET Command"]
pub mod aetcmd;
#[doc = "MPFAR (rw) register accessor: Memory Protect Fault Address\n\nYou can [`read`](crate::Reg::read) this register and get [`mpfar::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpfar::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@mpfar`]
module"]
#[doc(alias = "MPFAR")]
pub type Mpfar = crate::Reg<mpfar::MpfarSpec>;
#[doc = "Memory Protect Fault Address"]
pub mod mpfar;
#[doc = "MPFSR (rw) register accessor: Memory Protect Fault Status\n\nYou can [`read`](crate::Reg::read) this register and get [`mpfsr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpfsr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@mpfsr`]
module"]
#[doc(alias = "MPFSR")]
pub type Mpfsr = crate::Reg<mpfsr::MpfsrSpec>;
#[doc = "Memory Protect Fault Status"]
pub mod mpfsr;
#[doc = "MPFCR (rw) register accessor: Memory Protect Fault Command\n\nYou can [`read`](crate::Reg::read) this register and get [`mpfcr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpfcr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@mpfcr`]
module"]
#[doc(alias = "MPFCR")]
pub type Mpfcr = crate::Reg<mpfcr::MpfcrSpec>;
#[doc = "Memory Protect Fault Command"]
pub mod mpfcr;
#[doc = "MPPAG (rw) register accessor: MP Permission Attribute for Global Regs\n\nYou can [`read`](crate::Reg::read) this register and get [`mppag::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mppag::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@mppag`]
module"]
#[doc(alias = "MPPAG")]
pub type Mppag = crate::Reg<mppag::MppagSpec>;
#[doc = "MP Permission Attribute for Global Regs"]
pub mod mppag;
#[doc = "MPPAN (rw) register accessor: MP Permission Attribute for DMA Region N starting from 0x810 to 0x82C total 8 regions\n\nYou can [`read`](crate::Reg::read) this register and get [`mppan::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mppan::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@mppan`]
module"]
#[doc(alias = "MPPAN")]
pub type Mppan = crate::Reg<mppan::MppanSpec>;
