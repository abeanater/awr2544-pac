#[doc = "Register `Programmable 3 MPPA` reader"]
pub type R = crate::R<Programmable3mppaSpec>;
#[doc = "Register `Programmable 3 MPPA` writer"]
pub type W = crate::W<Programmable3mppaSpec>;
...
User executable permission. Defaults to input value."]
    #[inline(always)]
    #[must_use]
    pub fn ux(&mut self) -> UxW<Programmable3mppaSpec> {
        UxW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
User write permission. Defaults to input value."]
    #[inline(always)]
    #[must_use]
    pub fn uw(&mut self) -> UwW<Programmable3mppaSpec> {
        UwW::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
User read permission. Defaults to input value."]
    #[inline(always)]
    #[must_use]
    pub fn ur(&mut self) -> UrW<Programmable3mppaSpec> {
        UrW::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
Supervisor executable permission. Defaults to input value."]
    #[inline(always)]
    #[must_use]
    pub fn sx(&mut self) -> SxW<Programmable3mppaSpec> {
        SxW::new(self, 3)
    }
    #[doc = "Bit 4 - 4:4\\]
Supervisor write permission. Defaults to input value."]
    #[inline(always)]
    #[must_use]
    pub fn sw(&mut self) -> SwW<Programmable3mppaSpec> {
        SwW::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
Supervisor read permission. Defaults to input value."]
    #[inline(always)]
    #[must_use]
    pub fn sr(&mut self) -> SrW<Programmable3mppaSpec> {
        SrW::new(self, 5)
    }
    #[doc = "Bit 6 - 6:6\\]
Debug permission. Defaults to input value."]
    #[inline(always)]
    #[must_use]
    pub fn emu(&mut self) -> EmuW<Programmable3mppaSpec> {
        EmuW::new(self, 6)
    }
    #[doc = "Bit 7 - 7:7\\]
Non-secure permission. Defaults to input value."]
    #[inline(always)]
    #[must_use]
    pub fn ns(&mut self) -> NsW<Programmable3mppaSpec> {
        NsW::new(self, 7)
    }
    #[doc = "Bit 8 - 8:8\\]
Always read as 0."]
    #[inline(always)]
    #[must_use]
    pub fn reserved1(&mut self) -> Reserved1W<Programmable3mppaSpec> {
...
Additional AIDs checked. Defaults to input value."]
    #[inline(always)]
    #[must_use]
    pub fn aidx(&mut self) -> AidxW<Programmable3mppaSpec> {
        AidxW::new(self, 9)
    }
    #[doc = "Bits 10:25 - 25:10\\]
AIDs checked for this region. Defaults to input value. 0 = AID is not checked for these permissions. 1 = AID is checked for these permissions."]
    #[inline(always)]
    #[must_use]
    pub fn aid15_0(&mut self) -> Aid15_0W<Programmable3mppaSpec> {
        Aid15_0W::new(self, 10)
    }
}
#[doc = "Programmable 3 MPPA\n\nYou can [`read`](crate::Reg::read) this register and get [`programmable3mppa::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`programmable3mppa::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Programmable3mppaSpec;
impl crate::RegisterSpec for Programmable3mppaSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`programmable3mppa::R`](R) reader structure"]
impl crate::Readable for Programmable3mppaSpec {}
#[doc = "`write(|w| ..)` method takes [`programmable3mppa::W`](W) writer structure"]
impl crate::Writable for Programmable3mppaSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets Programmable 3 MPPA to value 0"]
impl crate::Resettable for Programmable3mppaSpec {
