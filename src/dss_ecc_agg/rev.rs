...
Minor version"]
    #[inline(always)]
    #[must_use]
    pub fn minor_version(&mut self) -> MinorVersionW<RevSpec> {
...
Custom version"]
    #[inline(always)]
    #[must_use]
    pub fn custom_version(&mut self) -> CustomVersionW<RevSpec> {
...
Major version"]
    #[inline(always)]
    #[must_use]
    pub fn major_version(&mut self) -> MajorVersionW<RevSpec> {
...
RTL version"]
    #[inline(always)]
    #[must_use]
    pub fn rtl_version(&mut self) -> RtlVersionW<RevSpec> {
