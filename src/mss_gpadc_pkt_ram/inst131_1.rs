#[doc = "Register `INST131_1` reader"]
pub type R = crate::R<Inst131_1Spec>;
#[doc = "Register `INST131_1` writer"]
pub type W = crate::W<Inst131_1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn param(&mut self) -> ParamW<Inst131_1Spec> {
        ParamW::new(self, 0)
    }
    #[doc = "Bits 8:15"]
    #[inline(always)]
    #[must_use]
    pub fn collect_samples(&mut self) -> CollectSamplesW<Inst131_1Spec> {
        CollectSamplesW::new(self, 8)
    }
    #[doc = "Bits 16:22"]
    #[inline(always)]
    #[must_use]
    pub fn skip_samples(&mut self) -> SkipSamplesW<Inst131_1Spec> {
        SkipSamplesW::new(self, 16)
    }
    #[doc = "Bit 23"]
    #[inline(always)]
    #[must_use]
    pub fn chirp_brk(&mut self) -> ChirpBrkW<Inst131_1Spec> {
        ChirpBrkW::new(self, 23)
    }
    #[doc = "Bit 24"]
    #[inline(always)]
    #[must_use]
    pub fn nu1(&mut self) -> Nu1W<Inst131_1Spec> {
        Nu1W::new(self, 24)
    }
    #[doc = "Bits 25:31"]
    #[inline(always)]
    #[must_use]
    pub fn nu2(&mut self) -> Nu2W<Inst131_1Spec> {
        Nu2W::new(self, 25)
    }
}
#[doc = "INST131_1\n\nYou can [`read`](crate::Reg::read) this register and get [`inst131_1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`inst131_1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Inst131_1Spec;
impl crate::RegisterSpec for Inst131_1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`inst131_1::R`](R) reader structure"]
impl crate::Readable for Inst131_1Spec {}
#[doc = "`write(|w| ..)` method takes [`inst131_1::W`](W) writer structure"]
impl crate::Writable for Inst131_1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets INST131_1 to value 0"]
impl crate::Resettable for Inst131_1Spec {
