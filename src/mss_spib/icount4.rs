#[doc = "Register `ICOUNT4` reader"]
pub type R = crate::R<Icount4Spec>;
#[doc = "Register `ICOUNT4` writer"]
pub type W = crate::W<Icount4Spec>;
...
Actual number of remaining DMA transfer COUNTx is a read-only bit field. It comprises the actual number of DMA transfers that remain, until the DMA channel is disabled if ONESHOTx is set. Since the real COUNTx is always ICLOUNTx +1, the 17th bit of COUNTx is available on DMAxCTRL(6) bit."]
    #[inline(always)]
    #[must_use]
    pub fn count(&mut self) -> CountW<Icount4Spec> {
        CountW::new(self, 0)
    }
    #[doc = "Bits 16:31 - 31:16\\]
Initial Number of DMA transfers. ICOUNTx is used to preset the transfer counter COUNTx. Every time COUNTx hits zero it is reloaded with ICOUNTx. The real number of transfer equals ICOUNTx plus one. If ONESHOTx is set, ICOUNTx defines the number of DMA transfers that are performed before the MibSPI automatically disables the DMA channels. If NOBRKx is set, ICOUNTx defines the number of DMA transfers that are performed in one sequence without a transfer from any other buffer"]
    #[inline(always)]
    #[must_use]
    pub fn icount(&mut self) -> IcountW<Icount4Spec> {
        IcountW::new(self, 16)
    }
}
#[doc = "MibSPI DMAxCOUNT\n\nYou can [`read`](crate::Reg::read) this register and get [`icount4::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`icount4::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Icount4Spec;
impl crate::RegisterSpec for Icount4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`icount4::R`](R) reader structure"]
impl crate::Readable for Icount4Spec {}
#[doc = "`write(|w| ..)` method takes [`icount4::W`](W) writer structure"]
impl crate::Writable for Icount4Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ICOUNT4 to value 0"]
impl crate::Resettable for Icount4Spec {
