#[doc = "Register `PLL_CORE_HSDIVIDER` reader"]
pub type R = crate::R<PllCoreHsdividerSpec>;
#[doc = "Register `PLL_CORE_HSDIVIDER` writer"]
pub type W = crate::W<PllCoreHsdividerSpec>;
...
HSDIVIDER Bypass"]
    #[inline(always)]
    #[must_use]
    pub fn bypass(&mut self) -> BypassW<PllCoreHsdividerSpec> {
        BypassW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
LDO Power Down"]
    #[inline(always)]
    #[must_use]
    pub fn ldopwdn(&mut self) -> LdopwdnW<PllCoreHsdividerSpec> {
        LdopwdnW::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
Tenable Div"]
    #[inline(always)]
    #[must_use]
    pub fn tenablediv(&mut self) -> TenabledivW<PllCoreHsdividerSpec> {
...
HSDIVIDER Bypass Ack"]
    #[inline(always)]
    #[must_use]
    pub fn bypassackz(&mut self) -> BypassackzW<PllCoreHsdividerSpec> {
...
LDO Power Down Ack"]
    #[inline(always)]
    #[must_use]
    pub fn ldopwdnack(&mut self) -> LdopwdnackW<PllCoreHsdividerSpec> {
...
pub struct PllCoreHsdividerSpec;
impl crate::RegisterSpec for PllCoreHsdividerSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pll_core_hsdivider::R`](R) reader structure"]
impl crate::Readable for PllCoreHsdividerSpec {}
#[doc = "`write(|w| ..)` method takes [`pll_core_hsdivider::W`](W) writer structure"]
impl crate::Writable for PllCoreHsdividerSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PLL_CORE_HSDIVIDER to value 0"]
impl crate::Resettable for PllCoreHsdividerSpec {
