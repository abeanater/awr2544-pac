#[doc = "Register `PLL_PER_HSDIVIDER_CLKOUT3` reader"]
pub type R = crate::R<PllPerHsdividerClkout3Spec>;
#[doc = "Register `PLL_PER_HSDIVIDER_CLKOUT3` writer"]
pub type W = crate::W<PllPerHsdividerClkout3Spec>;
...
DPLL post-divider factor, M7, for internal clock generation. Divide values from 1 to 31. 0h (R/W) = Reserved"]
    #[inline(always)]
    #[must_use]
    pub fn div(&mut self) -> DivW<PllPerHsdividerClkout3Spec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 5 - 5:5\\]
Toggle on this status bit after changing HSDIVIDER_CLKOUT3_DIV indicates that the change in divider value has taken effect"]
    #[inline(always)]
    #[must_use]
    pub fn divchack(&mut self) -> DivchackW<PllPerHsdividerClkout3Spec> {
...
Control gating of HSDIVIDER CLKOUT3 0h (R/W) = Automatically gate this clock when there is no dependency for it 1h (R/W) = Force this clock to stay enabled even if there is no request"]
    #[inline(always)]
    #[must_use]
    pub fn gate_ctrl(&mut self) -> GateCtrlW<PllPerHsdividerClkout3Spec> {
...
HSDIVIDER CLKOUT3 status 0h (R) = The clock output is gated 1h (R) = The clock output is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn status(&mut self) -> StatusW<PllPerHsdividerClkout3Spec> {
        StatusW::new(self, 9)
    }
    #[doc = "Bit 12 - 12:12\\]
Power down for HSDIVIDER M7 divider and hence CLKOUT3 output 0h (R/W) = CLKOUT3 divider active 1h (R/W) = CLKOUT3 divider is powered down"]
    #[inline(always)]
    #[must_use]
    pub fn pwdn(&mut self) -> PwdnW<PllPerHsdividerClkout3Spec> {
        PwdnW::new(self, 12)
    }
}
#[doc = "PLL_PER_HSDIVIDER_CLKOUT3\n\nYou can [`read`](crate::Reg::read) this register and get [`pll_per_hsdivider_clkout3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pll_per_hsdivider_clkout3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PllPerHsdividerClkout3Spec;
impl crate::RegisterSpec for PllPerHsdividerClkout3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pll_per_hsdivider_clkout3::R`](R) reader structure"]
impl crate::Readable for PllPerHsdividerClkout3Spec {}
#[doc = "`write(|w| ..)` method takes [`pll_per_hsdivider_clkout3::W`](W) writer structure"]
impl crate::Writable for PllPerHsdividerClkout3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PLL_PER_HSDIVIDER_CLKOUT3 to value 0"]
impl crate::Resettable for PllPerHsdividerClkout3Spec {
