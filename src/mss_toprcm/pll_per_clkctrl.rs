#[doc = "Register `PLL_PER_CLKCTRL` reader"]
pub type R = crate::R<PllPerClkctrlSpec>;
#[doc = "Register `PLL_PER_CLKCTRL` writer"]
pub type W = crate::W<PllPerClkctrlSpec>;
...
PLL core soft reset"]
    #[inline(always)]
    #[must_use]
    pub fn tintz(&mut self) -> TintzW<PllPerClkctrlSpec> {
        TintzW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
SSC Type"]
    #[inline(always)]
    #[must_use]
    pub fn ssctype(&mut self) -> SsctypeW<PllPerClkctrlSpec> {
        SsctypeW::new(self, 1)
    }
    #[doc = "Bit 8 - 8:8\\]
Decides when FREQLOCK asserted 0x0: FREQLOCK asserted when DC frequency error less than 1% 0x1: FREQLOCK asserted when DC frequency error less than 2%"]
    #[inline(always)]
    #[must_use]
    pub fn relaxed_lock(&mut self) -> RelaxedLockW<PllPerClkctrlSpec> {
...
DCO Clock (DCOCLK = CLKINP * \\[M/(N+1)\\]) frequency range selector. 0x0: Reserved 0x2: HS2 : DCOCLK range is from 500 MHz to 1000 MHz 0x3: Reserved 0x4: HS1: DCOCLK range is from 1000 MHz to 2000 MHz 0x5: Reserved"]
    #[inline(always)]
    #[must_use]
    pub fn selfreqdco(&mut self) -> SelfreqdcoW<PllPerClkctrlSpec> {
...
When in Lossclk/Stbyret 0x0 : Limp mode 0x1 : Stopmode"]
    #[inline(always)]
    #[must_use]
    pub fn stopmode(&mut self) -> StopmodeW<PllPerClkctrlSpec> {
...
M2 divider power down mode 0x0: Asynchronous power down for M2 divider 0x1 : M2 divider is functional"]
    #[inline(always)]
    #[must_use]
    pub fn m2pwdnz(&mut self) -> M2pwdnzW<PllPerClkctrlSpec> {
...
0 Asynchronous power down for CLKDCOLDO o/p."]
    #[inline(always)]
    #[must_use]
    pub fn clkdcoldopwdnz(&mut self) -> ClkdcoldopwdnzW<PllPerClkctrlSpec> {
...
Select CLKOUT source in bypass 0x0: When ADPLLLJ in bypass mode, CLKOUT = CLKINP/(N2+1) 0x1: When ADPLLLJ in bypass mode, CLKOUT = CLKINPULOW."]
    #[inline(always)]
    #[must_use]
    pub fn ulowclken(&mut self) -> UlowclkenW<PllPerClkctrlSpec> {
...
Synchronously enables/disables CLKOUTLDO 0x0 : synchronously disables CLKOUTLDO 0x1 : synchronously enables CLKOUTLDO"]
    #[inline(always)]
    #[must_use]
    pub fn clkoutldoen(&mut self) -> ClkoutldoenW<PllPerClkctrlSpec> {
...
CLKOUT enable or disable 0x0 : synchronously disables CLKOUT 0x1 : synchronously enables CLKOUT"]
    #[inline(always)]
    #[must_use]
    pub fn clkouten(&mut self) -> ClkoutenW<PllPerClkctrlSpec> {
...
Standby retention control 0x0 : prepares ADPLLLJ for relock when out of retention by removing the gating on all internal clocks. 0x1 : prepares ADPLLLJ for retention by gating all the internal clocks."]
    #[inline(always)]
    #[must_use]
    pub fn stbyret(&mut self) -> StbyretW<PllPerClkctrlSpec> {
...
BYPASSACKZ is a special purpose input to the module. In general this input is expected to be tied to static low. For the output clocks of the module that do not have an internal bypass mux viz. CLKDCOLDO and CLKOUTLDO, a bypass mux could be implemented external to the module."]
    #[inline(always)]
    #[must_use]
    pub fn bypassackz(&mut self) -> BypassackzW<PllPerClkctrlSpec> {
...
Sets PLL to Idle mode 0x0 : When SYSRESET = 0 and TINITZ = 1 IDLE = 0 PLL will go to Active and Locked 0x1 : When SYSRESET = 0 and TINITZ = 1 IDLE = 1 PLL will go to Idle Bypass low powe"]
    #[inline(always)]
    #[must_use]
    pub fn idle(&mut self) -> IdleW<PllPerClkctrlSpec> {
        IdleW::new(self, 23)
    }
    #[doc = "Bits 24:28 - 28:24\\]
Trim value for the PLL"]
    #[inline(always)]
    #[must_use]
    pub fn nwelltrim(&mut self) -> NwelltrimW<PllPerClkctrlSpec> {
...
Synchronously enables/disables CLKDCOLDO 0x0 : synchronously disables CLKDCOLDO 0x1 : synchronously enables CLKDCOLDO"]
    #[inline(always)]
    #[must_use]
    pub fn clkdcoldoen(&mut self) -> ClkdcoldoenW<PllPerClkctrlSpec> {
...
Controls Clock Spreading. SSC is not supported. Should be set to 0x0 to disable clock spreading."]
    #[inline(always)]
    #[must_use]
    pub fn enssc(&mut self) -> EnsscW<PllPerClkctrlSpec> {
        EnsscW::new(self, 30)
    }
    #[doc = "Bit 31 - 31:31\\]
FailSafe enable to trigger re-calibration in case CycleSlip occurs between REFCLK and FBCLK."]
    #[inline(always)]
    #[must_use]
    pub fn cycleslipen(&mut self) -> CycleslipenW<PllPerClkctrlSpec> {
        CycleslipenW::new(self, 31)
    }
}
#[doc = "PLL_PER_CLKCTRL\n\nYou can [`read`](crate::Reg::read) this register and get [`pll_per_clkctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pll_per_clkctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PllPerClkctrlSpec;
impl crate::RegisterSpec for PllPerClkctrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pll_per_clkctrl::R`](R) reader structure"]
impl crate::Readable for PllPerClkctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`pll_per_clkctrl::W`](W) writer structure"]
impl crate::Writable for PllPerClkctrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PLL_PER_CLKCTRL to value 0"]
impl crate::Resettable for PllPerClkctrlSpec {
