#[doc = "Register `PLL_CORE_HSDIVIDER_CLKOUT2` reader"]
pub type R = crate::R<PllCoreHsdividerClkout2Spec>;
#[doc = "Register `PLL_CORE_HSDIVIDER_CLKOUT2` writer"]
pub type W = crate::W<PllCoreHsdividerClkout2Spec>;
...
DPLL post-divider factor, M6, for internal clock generation. Divide values from 1 to 31. 0h (R/W) = Reserved"]
    #[inline(always)]
    #[must_use]
    pub fn div(&mut self) -> DivW<PllCoreHsdividerClkout2Spec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 5 - 5:5\\]
Toggle on this status bit after changing HSDIVIDER_CLKOUT2_DIV indicates that the change in divider value has taken effect"]
    #[inline(always)]
    #[must_use]
    pub fn divchack(&mut self) -> DivchackW<PllCoreHsdividerClkout2Spec> {
...
Control gating of HSDIVIDER CLKOUT2 0h (R/W) = Automatically gate this clock when there is no dependency for it 1h (R/W) = Force this clock to stay enabled even if there is no request"]
    #[inline(always)]
    #[must_use]
    pub fn gate_ctrl(&mut self) -> GateCtrlW<PllCoreHsdividerClkout2Spec> {
...
HSDIVIDER CLKOUT2 status 0h (R) = The clock output is gated 1h (R) = The clock output is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn status(&mut self) -> StatusW<PllCoreHsdividerClkout2Spec> {
        StatusW::new(self, 9)
    }
    #[doc = "Bit 12 - 12:12\\]
Power down for HSDIVIDER M6 divider and hence CLKOUT2 output 0h (R/W) = CLKOUT2 divider active 1h (R/W) = CLKOUT2 divider is powered down"]
    #[inline(always)]
    #[must_use]
    pub fn pwdn(&mut self) -> PwdnW<PllCoreHsdividerClkout2Spec> {
        PwdnW::new(self, 12)
    }
}
#[doc = "PLL_CORE_HSDIVIDER_CLKOUT2\n\nYou can [`read`](crate::Reg::read) this register and get [`pll_core_hsdivider_clkout2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pll_core_hsdivider_clkout2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PllCoreHsdividerClkout2Spec;
impl crate::RegisterSpec for PllCoreHsdividerClkout2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pll_core_hsdivider_clkout2::R`](R) reader structure"]
impl crate::Readable for PllCoreHsdividerClkout2Spec {}
#[doc = "`write(|w| ..)` method takes [`pll_core_hsdivider_clkout2::W`](W) writer structure"]
impl crate::Writable for PllCoreHsdividerClkout2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PLL_CORE_HSDIVIDER_CLKOUT2 to value 0"]
impl crate::Resettable for PllCoreHsdividerClkout2Spec {
