#[doc = "Register `PLL_PER_PWRCTRL` reader"]
pub type R = crate::R<PllPerPwrctrlSpec>;
#[doc = "Register `PLL_PER_PWRCTRL` writer"]
pub type W = crate::W<PllPerPwrctrlSpec>;
...
Used to switch OFF the logic on VDDA. For functional mode it should be 0"]
    #[inline(always)]
    #[must_use]
    pub fn offmode(&mut self) -> OffmodeW<PllPerPwrctrlSpec> {
        OffmodeW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Save/Restore control for Isolation of the Scanout pins. For functional mode it should be 0"]
    #[inline(always)]
    #[must_use]
    pub fn isoscan(&mut self) -> IsoscanW<PllPerPwrctrlSpec> {
        IsoscanW::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
Save/Restore control for Isolation of output pins For functional mode it should be 0"]
    #[inline(always)]
    #[must_use]
    pub fn isoret(&mut self) -> IsoretW<PllPerPwrctrlSpec> {
        IsoretW::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
Save/Restore control for Retention mode. For functional mode it should be 0"]
    #[inline(always)]
    #[must_use]
    pub fn ret(&mut self) -> RetW<PllPerPwrctrlSpec> {
        RetW::new(self, 3)
    }
    #[doc = "Bit 4 - 4:4\\]
ON/OFF control of the strong power switch digital. For functional mode it should be 1"]
    #[inline(always)]
    #[must_use]
    pub fn pgoodin(&mut self) -> PgoodinW<PllPerPwrctrlSpec> {
        PgoodinW::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
ON/OFF control of the weak power switch digital. For functional mode it should be 1"]
    #[inline(always)]
    #[must_use]
    pub fn ponin(&mut self) -> PoninW<PllPerPwrctrlSpec> {
        PoninW::new(self, 5)
    }
}
#[doc = "PLL_PER_PWRCTRL\n\nYou can [`read`](crate::Reg::read) this register and get [`pll_per_pwrctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pll_per_pwrctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PllPerPwrctrlSpec;
impl crate::RegisterSpec for PllPerPwrctrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pll_per_pwrctrl::R`](R) reader structure"]
impl crate::Readable for PllPerPwrctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`pll_per_pwrctrl::W`](W) writer structure"]
impl crate::Writable for PllPerPwrctrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PLL_PER_PWRCTRL to value 0"]
impl crate::Resettable for PllPerPwrctrlSpec {
