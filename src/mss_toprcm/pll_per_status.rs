#[doc = "Register `PLL_PER_STATUS` reader"]
pub type R = crate::R<PllPerStatusSpec>;
#[doc = "Register `PLL_PER_STATUS` writer"]
pub type W = crate::W<PllPerStatusSpec>;
...
Bypass status signal. 1 CLKOUT in bypass"]
    #[inline(always)]
    #[must_use]
    pub fn bypass(&mut self) -> BypassW<PllPerStatusSpec> {
        BypassW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
1 indicates jitter. After PHASELOCK is asserted high, the HIGHJITTER flag is asserted high if phase error between REFCLK and FBCLK greater than 24%."]
    #[inline(always)]
    #[must_use]
    pub fn highjitter(&mut self) -> HighjitterW<PllPerStatusSpec> {
...
Spread Spectrum status 0x0 : Spread-spectrum Clocking is disabled on output clocks 0x1 : Spread-spectrum Clocking is enabled on output clocks"]
    #[inline(always)]
    #[must_use]
    pub fn sscack(&mut self) -> SscackW<PllPerStatusSpec> {
        SscackW::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
Acknowledge for change to M2 divider. Toggles from 1-0 or 0-1 (depending on current value) once CLKOUT frequency change has completed."]
    #[inline(always)]
    #[must_use]
    pub fn m2changeack(&mut self) -> M2changeackW<PllPerStatusSpec> {
...
ADPLL internal loop lock status"]
    #[inline(always)]
    #[must_use]
    pub fn lock2(&mut self) -> Lock2W<PllPerStatusSpec> {
        Lock2W::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
Indicates the enable/disable condition of CLKOUTEN 0x0 = CLKOUT gating completed 0x1 = CLKOUT enabling completed"]
    #[inline(always)]
    #[must_use]
    pub fn clkoutenack(&mut self) -> ClkoutenackW<PllPerStatusSpec> {
...
Reference input loss"]
    #[inline(always)]
    #[must_use]
    pub fn lossref(&mut self) -> LossrefW<PllPerStatusSpec> {
        LossrefW::new(self, 6)
    }
    #[doc = "Bit 7 - 7:7\\]
Standby and retention status 0x0: indicates to SOC that all internal clocks in ADPLLLJ are active and it is starting the relock process. 0x1: indicates to SOC that all internal clocks in ADPLLLJ are gated and it is ready for retention."]
    #[inline(always)]
    #[must_use]
    pub fn stbyretack(&mut self) -> StbyretackW<PllPerStatusSpec> {
...
Status of BYPASSACK output pin"]
    #[inline(always)]
    #[must_use]
    pub fn bypassack(&mut self) -> BypassackW<PllPerStatusSpec> {
...
Status on FREQLOCK output pin"]
    #[inline(always)]
    #[must_use]
    pub fn freqlock(&mut self) -> FreqlockW<PllPerStatusSpec> {
...
Status on PHASELOCK output pin"]
    #[inline(always)]
    #[must_use]
    pub fn phaselock(&mut self) -> PhaselockW<PllPerStatusSpec> {
...
Status on PHASELOCK output pin"]
    #[inline(always)]
    #[must_use]
    pub fn clkdcoldoack(&mut self) -> ClkdcoldoackW<PllPerStatusSpec> {
...
Recalibration status flag. 1 ADPLLLJ requires recalibration"]
    #[inline(always)]
    #[must_use]
    pub fn recal_oppin(&mut self) -> RecalOppinW<PllPerStatusSpec> {
...
Recalibration status flag. 1 ADPLLLJ requires recalibration"]
    #[inline(always)]
    #[must_use]
    pub fn recal_bstatus3(&mut self) -> RecalBstatus3W<PllPerStatusSpec> {
...
1 indicates ADPLLLJ internal LDO is power down. VDDLDOOUT will be un-defined in this condition"]
    #[inline(always)]
    #[must_use]
    pub fn ldopwdn(&mut self) -> LdopwdnW<PllPerStatusSpec> {
...
Status of the strong power-switch 0x0 : indicates the/OFF status of the strong power-switch in digital to SOC. 0x1 : ndicates the ON status of the strong power-switch in digital to SOC."]
    #[inline(always)]
    #[must_use]
    pub fn pgoodout(&mut self) -> PgoodoutW<PllPerStatusSpec> {
...
Status of the weak power-switch 0x0 : indicates the/OFF status of the weak power-switch in digital to SOC. 0x1 : ndicates the ON status of the weak power-switch in digital to SOC."]
    #[inline(always)]
    #[must_use]
    pub fn ponout(&mut self) -> PonoutW<PllPerStatusSpec> {
        PonoutW::new(self, 31)
    }
}
#[doc = "PLL_PER_STATUS\n\nYou can [`read`](crate::Reg::read) this register and get [`pll_per_status::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pll_per_status::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PllPerStatusSpec;
impl crate::RegisterSpec for PllPerStatusSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pll_per_status::R`](R) reader structure"]
impl crate::Readable for PllPerStatusSpec {}
#[doc = "`write(|w| ..)` method takes [`pll_per_status::W`](W) writer structure"]
impl crate::Writable for PllPerStatusSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PLL_PER_STATUS to value 0"]
impl crate::Resettable for PllPerStatusSpec {
