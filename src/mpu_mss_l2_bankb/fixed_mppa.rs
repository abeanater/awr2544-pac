#[doc = "Register `Fixed MPPA` reader"]
pub type R = crate::R<FixedMppaSpec>;
#[doc = "Register `Fixed MPPA` writer"]
pub type W = crate::W<FixedMppaSpec>;
...
Reserved not used in Design"]
    #[inline(always)]
    #[must_use]
    pub fn ux(&mut self) -> UxW<FixedMppaSpec> {
        UxW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Reserved not used in Design"]
    #[inline(always)]
    #[must_use]
    pub fn uw(&mut self) -> UwW<FixedMppaSpec> {
        UwW::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
Reserved not used in Design"]
    #[inline(always)]
    #[must_use]
    pub fn ur(&mut self) -> UrW<FixedMppaSpec> {
        UrW::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
Reserved not used in Design"]
    #[inline(always)]
    #[must_use]
    pub fn sx(&mut self) -> SxW<FixedMppaSpec> {
        SxW::new(self, 3)
    }
    #[doc = "Bit 4 - 4:4\\]
Reserved not used in Design"]
    #[inline(always)]
    #[must_use]
    pub fn sw(&mut self) -> SwW<FixedMppaSpec> {
        SwW::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
Reserved not used in Design"]
    #[inline(always)]
    #[must_use]
    pub fn sr(&mut self) -> SrW<FixedMppaSpec> {
        SrW::new(self, 5)
    }
    #[doc = "Bit 6 - 6:6\\]
Reserved not used in Design"]
    #[inline(always)]
    #[must_use]
    pub fn emu(&mut self) -> EmuW<FixedMppaSpec> {
        EmuW::new(self, 6)
    }
    #[doc = "Bit 7 - 7:7\\]
Reserved not used in Design"]
    #[inline(always)]
    #[must_use]
    pub fn ns(&mut self) -> NsW<FixedMppaSpec> {
        NsW::new(self, 7)
    }
    #[doc = "Bit 8 - 8:8\\]
Reserved not used in Design"]
    #[inline(always)]
    #[must_use]
    pub fn reserved1(&mut self) -> Reserved1W<FixedMppaSpec> {
...
Reserved not used in Design"]
    #[inline(always)]
    #[must_use]
    pub fn aidx(&mut self) -> AidxW<FixedMppaSpec> {
        AidxW::new(self, 9)
    }
    #[doc = "Bits 10:25 - 25:10\\]
Reserved not used in Design"]
    #[inline(always)]
    #[must_use]
    pub fn aid15_0(&mut self) -> Aid15_0W<FixedMppaSpec> {
        Aid15_0W::new(self, 10)
    }
}
#[doc = "Fixed MPPA\n\nYou can [`read`](crate::Reg::read) this register and get [`fixed_mppa::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fixed_mppa::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FixedMppaSpec;
impl crate::RegisterSpec for FixedMppaSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fixed_mppa::R`](R) reader structure"]
impl crate::Readable for FixedMppaSpec {}
#[doc = "`write(|w| ..)` method takes [`fixed_mppa::W`](W) writer structure"]
impl crate::Writable for FixedMppaSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets Fixed MPPA to value 0"]
impl crate::Resettable for FixedMppaSpec {
