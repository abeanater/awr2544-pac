#[doc = "Register `PADBT_cfg_reg` reader"]
pub type R = crate::R<PadbtCfgRegSpec>;
#[doc = "Register `PADBT_cfg_reg` writer"]
pub type W = crate::W<PadbtCfgRegSpec>;
...
Function select"]
    #[inline(always)]
    #[must_use]
    pub fn func_sel(&mut self) -> FuncSelW<PadbtCfgRegSpec> {
        FuncSelW::new(self, 0)
    }
    #[doc = "Bit 4 - 4:4\\]
Active Low Input Override Control : Write 1 to select Active low Input Override value to control IOs IE_N/RXACTIVE_N instead of the control from hardware"]
    #[inline(always)]
    #[must_use]
    pub fn ie_override_ctrl(&mut self) -> IeOverrideCtrlW<PadbtCfgRegSpec> {
...
Active Low Input Override"]
    #[inline(always)]
    #[must_use]
    pub fn ie_override(&mut self) -> IeOverrideW<PadbtCfgRegSpec> {
...
Active Low Output Override Control : Write 1 to select Active low Output Override value to control IOs OE_N/GZ instead of the control from hardware"]
    #[inline(always)]
    #[must_use]
    pub fn oe_override_ctrl(&mut self) -> OeOverrideCtrlW<PadbtCfgRegSpec> {
...
Active Low Output Override"]
    #[inline(always)]
    #[must_use]
    pub fn oe_override(&mut self) -> OeOverrideW<PadbtCfgRegSpec> {
...
Pull Inhibit/Pull Disable 0 -- Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pi(&mut self) -> PiW<PadbtCfgRegSpec> {
        PiW::new(self, 8)
    }
    #[doc = "Bit 9 - 9:9\\]
Pullup/PullDown Selection 0 -- Pull Down"]
    #[inline(always)]
    #[must_use]
    pub fn pupdsel(&mut self) -> PupdselW<PadbtCfgRegSpec> {
        PupdselW::new(self, 9)
    }
    #[doc = "Bit 10 - 10:10\\]
IO Slew rate control : 0 : higher slew rate. 1: Lower slew rate."]
    #[inline(always)]
    #[must_use]
    pub fn sc1(&mut self) -> Sc1W<PadbtCfgRegSpec> {
        Sc1W::new(self, 10)
    }
    #[doc = "Bits 11:31 - 31:11\\]
Reserved"]
    #[inline(always)]
    #[must_use]
    pub fn nu(&mut self) -> NuW<PadbtCfgRegSpec> {
        NuW::new(self, 11)
    }
}
#[doc = "PADBT_cfg_reg\n\nYou can [`read`](crate::Reg::read) this register and get [`padbt_cfg_reg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`padbt_cfg_reg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PadbtCfgRegSpec;
impl crate::RegisterSpec for PadbtCfgRegSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`padbt_cfg_reg::R`](R) reader structure"]
impl crate::Readable for PadbtCfgRegSpec {}
#[doc = "`write(|w| ..)` method takes [`padbt_cfg_reg::W`](W) writer structure"]
impl crate::Writable for PadbtCfgRegSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PADBT_cfg_reg to value 0"]
impl crate::Resettable for PadbtCfgRegSpec {
