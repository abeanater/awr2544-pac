#[doc = "Register `PADAV_cfg_reg` reader"]
pub type R = crate::R<PadavCfgRegSpec>;
#[doc = "Register `PADAV_cfg_reg` writer"]
pub type W = crate::W<PadavCfgRegSpec>;
...
Function select"]
    #[inline(always)]
    #[must_use]
    pub fn func_sel(&mut self) -> FuncSelW<PadavCfgRegSpec> {
        FuncSelW::new(self, 0)
    }
    #[doc = "Bit 4 - 4:4\\]
Active Low Input Override Control : Write 1 to select Active low Input Override value to control IOs IE_N/RXACTIVE_N instead of the control from hardware"]
    #[inline(always)]
    #[must_use]
    pub fn ie_override_ctrl(&mut self) -> IeOverrideCtrlW<PadavCfgRegSpec> {
...
Active Low Input Override"]
    #[inline(always)]
    #[must_use]
    pub fn ie_override(&mut self) -> IeOverrideW<PadavCfgRegSpec> {
...
Active Low Output Override Control : Write 1 to select Active low Output Override value to control IOs OE_N/GZ instead of the control from hardware"]
    #[inline(always)]
    #[must_use]
    pub fn oe_override_ctrl(&mut self) -> OeOverrideCtrlW<PadavCfgRegSpec> {
...
Active Low Output Override"]
    #[inline(always)]
    #[must_use]
    pub fn oe_override(&mut self) -> OeOverrideW<PadavCfgRegSpec> {
...
Pull Inhibit/Pull Disable 0 -- Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pi(&mut self) -> PiW<PadavCfgRegSpec> {
        PiW::new(self, 8)
    }
    #[doc = "Bit 9 - 9:9\\]
Pullup/PullDown Selection 0 -- Pull Down"]
    #[inline(always)]
    #[must_use]
    pub fn pupdsel(&mut self) -> PupdselW<PadavCfgRegSpec> {
        PupdselW::new(self, 9)
    }
    #[doc = "Bit 10 - 10:10\\]
IO Slew rate control : 0 : higher slew rate. 1: Lower slew rate."]
    #[inline(always)]
    #[must_use]
    pub fn sc1(&mut self) -> Sc1W<PadavCfgRegSpec> {
        Sc1W::new(self, 10)
    }
    #[doc = "Bits 11:31 - 31:11\\]
Reserved"]
    #[inline(always)]
    #[must_use]
    pub fn nu(&mut self) -> NuW<PadavCfgRegSpec> {
        NuW::new(self, 11)
    }
}
...
pub struct PadavCfgRegSpec;
impl crate::RegisterSpec for PadavCfgRegSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`padav_cfg_reg::R`](R) reader structure"]
impl crate::Readable for PadavCfgRegSpec {}
#[doc = "`write(|w| ..)` method takes [`padav_cfg_reg::W`](W) writer structure"]
impl crate::Writable for PadavCfgRegSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PADAV_cfg_reg to value 0"]
impl crate::Resettable for PadavCfgRegSpec {
