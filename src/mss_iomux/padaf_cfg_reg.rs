#[doc = "Register `PADAF_cfg_reg` reader"]
pub type R = crate::R<PadafCfgRegSpec>;
#[doc = "Register `PADAF_cfg_reg` writer"]
pub type W = crate::W<PadafCfgRegSpec>;
...
Function select"]
    #[inline(always)]
    #[must_use]
    pub fn func_sel(&mut self) -> FuncSelW<PadafCfgRegSpec> {
        FuncSelW::new(self, 0)
    }
    #[doc = "Bit 4 - 4:4\\]
Active Low Input Override Control : Write 1 to select Active low Input Override value to control IOs IE_N/RXACTIVE_N instead of the control from hardware"]
    #[inline(always)]
    #[must_use]
    pub fn ie_override_ctrl(&mut self) -> IeOverrideCtrlW<PadafCfgRegSpec> {
...
Active Low Input Override"]
    #[inline(always)]
    #[must_use]
    pub fn ie_override(&mut self) -> IeOverrideW<PadafCfgRegSpec> {
...
Active Low Output Override Control : Write 1 to select Active low Output Override value to control IOs OE_N/GZ instead of the control from hardware"]
    #[inline(always)]
    #[must_use]
    pub fn oe_override_ctrl(&mut self) -> OeOverrideCtrlW<PadafCfgRegSpec> {
...
Active Low Output Override"]
    #[inline(always)]
    #[must_use]
    pub fn oe_override(&mut self) -> OeOverrideW<PadafCfgRegSpec> {
...
Pull Inhibit/Pull Disable 0 -- Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pi(&mut self) -> PiW<PadafCfgRegSpec> {
        PiW::new(self, 8)
    }
    #[doc = "Bit 9 - 9:9\\]
Pullup/PullDown Selection 0 -- Pull Down"]
    #[inline(always)]
    #[must_use]
    pub fn pupdsel(&mut self) -> PupdselW<PadafCfgRegSpec> {
        PupdselW::new(self, 9)
    }
    #[doc = "Bit 10 - 10:10\\]
IO Slew rate control : 0 : higher slew rate. 1: Lower slew rate."]
    #[inline(always)]
    #[must_use]
    pub fn sc1(&mut self) -> Sc1W<PadafCfgRegSpec> {
        Sc1W::new(self, 10)
    }
    #[doc = "Bits 11:31 - 31:11\\]
Reserved"]
    #[inline(always)]
    #[must_use]
    pub fn nu(&mut self) -> NuW<PadafCfgRegSpec> {
        NuW::new(self, 11)
    }
}
...
pub struct PadafCfgRegSpec;
impl crate::RegisterSpec for PadafCfgRegSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`padaf_cfg_reg::R`](R) reader structure"]
impl crate::Readable for PadafCfgRegSpec {}
#[doc = "`write(|w| ..)` method takes [`padaf_cfg_reg::W`](W) writer structure"]
impl crate::Writable for PadafCfgRegSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PADAF_cfg_reg to value 0"]
impl crate::Resettable for PadafCfgRegSpec {
