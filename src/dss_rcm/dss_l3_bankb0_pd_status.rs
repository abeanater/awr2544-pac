#[doc = "Register `DSS_L3_BANKB0_PD_STATUS` reader"]
pub type R = crate::R<DssL3Bankb0PdStatusSpec>;
#[doc = "Register `DSS_L3_BANKB0_PD_STATUS` writer"]
pub type W = crate::W<DssL3Bankb0PdStatusSpec>;
...
Status for &lt;IP>_PD_CTRL Memory Array Power up CRTL0"]
    #[inline(always)]
    #[must_use]
    pub fn aonout(&mut self) -> AonoutW<DssL3Bankb0PdStatusSpec> {
        AonoutW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Status for &lt;IP>_PD_CTRL Memory Array Power up CRTL1"]
    #[inline(always)]
    #[must_use]
    pub fn agoodout(&mut self) -> AgoodoutW<DssL3Bankb0PdStatusSpec> {
...
Status for sticky control &lt;IP>_PD_CTRL Memory Array Power up CRTL0"]
    #[inline(always)]
    #[must_use]
    pub fn aonin(&mut self) -> AoninW<DssL3Bankb0PdStatusSpec> {
        AoninW::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
Status for sticky control &lt;IP>_PD_CTRL Memory Array Power up CRTL1"]
    #[inline(always)]
    #[must_use]
    pub fn agoodin(&mut self) -> AgoodinW<DssL3Bankb0PdStatusSpec> {
        AgoodinW::new(self, 3)
    }
}
#[doc = "DSS_L3_BANKB0_PD_STATUS\n\nYou can [`read`](crate::Reg::read) this register and get [`dss_l3_bankb0_pd_status::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dss_l3_bankb0_pd_status::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DssL3Bankb0PdStatusSpec;
impl crate::RegisterSpec for DssL3Bankb0PdStatusSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dss_l3_bankb0_pd_status::R`](R) reader structure"]
impl crate::Readable for DssL3Bankb0PdStatusSpec {}
#[doc = "`write(|w| ..)` method takes [`dss_l3_bankb0_pd_status::W`](W) writer structure"]
impl crate::Writable for DssL3Bankb0PdStatusSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DSS_L3_BANKB0_PD_STATUS to value 0"]
impl crate::Resettable for DssL3Bankb0PdStatusSpec {
