#[doc = "Register `DSS_L3_BANKB0_PD_CTRL` reader"]
pub type R = crate::R<DssL3Bankb0PdCtrlSpec>;
#[doc = "Register `DSS_L3_BANKB0_PD_CTRL` writer"]
pub type W = crate::W<DssL3Bankb0PdCtrlSpec>;
...
SW Control for &lt;IP>_PD_CTRL Isolation"]
    #[inline(always)]
    #[must_use]
    pub fn iso(&mut self) -> IsoW<DssL3Bankb0PdCtrlSpec> {
        IsoW::new(self, 0)
    }
    #[doc = "Bits 4:6 - 6:4\\]
SW Control for &lt;IP>_PD_CTRL Memory Array Power up CRTL0"]
    #[inline(always)]
    #[must_use]
    pub fn aonin(&mut self) -> AoninW<DssL3Bankb0PdCtrlSpec> {
        AoninW::new(self, 4)
    }
    #[doc = "Bits 8:10 - 10:8\\]
SW Control for &lt;IP>_PD_CTRL Memory Array Power up CRTL1"]
    #[inline(always)]
    #[must_use]
    pub fn agoodin(&mut self) -> AgoodinW<DssL3Bankb0PdCtrlSpec> {
        AgoodinW::new(self, 8)
    }
}
...
pub struct DssL3Bankb0PdCtrlSpec;
impl crate::RegisterSpec for DssL3Bankb0PdCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dss_l3_bankb0_pd_ctrl::R`](R) reader structure"]
impl crate::Readable for DssL3Bankb0PdCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`dss_l3_bankb0_pd_ctrl::W`](W) writer structure"]
impl crate::Writable for DssL3Bankb0PdCtrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DSS_L3_BANKB0_PD_CTRL to value 0"]
impl crate::Resettable for DssL3Bankb0PdCtrlSpec {
