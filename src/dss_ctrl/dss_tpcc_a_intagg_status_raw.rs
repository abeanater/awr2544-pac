#[doc = "Register `DSS_TPCC_A_INTAGG_STATUS_RAW` reader"]
pub type R = crate::R<DssTpccAIntaggStatusRawSpec>;
#[doc = "Register `DSS_TPCC_A_INTAGG_STATUS_RAW` writer"]
pub type W = crate::W<DssTpccAIntaggStatusRawSpec>;
...
Raw Status of Interrupt from DSS_TPCC_A. Set irrespective if the Interupt is masked or unmasked in DSS_TPCC_A_INTAGG_MASK"]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_intg(&mut self) -> TpccAIntgW<DssTpccAIntaggStatusRawSpec> {
...
Raw Status of Interrupt from DSS_TPCC_A. Set irrespective if the Interupt is masked or unmasked in DSS_TPCC_A_INTAGG_MASK"]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_int0(&mut self) -> TpccAInt0W<DssTpccAIntaggStatusRawSpec> {
...
Raw Status of Interrupt from DSS_TPCC_A. Set irrespective if the Interupt is masked or unmasked in DSS_TPCC_A_INTAGG_MASK"]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_int1(&mut self) -> TpccAInt1W<DssTpccAIntaggStatusRawSpec> {
...
Raw Status of Interrupt from DSS_TPCC_A. Set irrespective if the Interupt is masked or unmasked in DSS_TPCC_A_INTAGG_MASK"]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_int2(&mut self) -> TpccAInt2W<DssTpccAIntaggStatusRawSpec> {
...
Raw Status of Interrupt from DSS_TPCC_A. Set irrespective if the Interupt is masked or unmasked in DSS_TPCC_A_INTAGG_MASK"]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_int3(&mut self) -> TpccAInt3W<DssTpccAIntaggStatusRawSpec> {
...
Raw Status of Interrupt from DSS_TPCC_A. Set irrespective if the Interupt is masked or unmasked in DSS_TPCC_A_INTAGG_MASK"]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_int4(&mut self) -> TpccAInt4W<DssTpccAIntaggStatusRawSpec> {
...
Raw Status of Interrupt from DSS_TPCC_A. Set irrespective if the Interupt is masked or unmasked in DSS_TPCC_A_INTAGG_MASK"]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_int5(&mut self) -> TpccAInt5W<DssTpccAIntaggStatusRawSpec> {
...
Raw Status of Interrupt from DSS_TPCC_A. Set irrespective if the Interupt is masked or unmasked in DSS_TPCC_A_INTAGG_MASK"]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_int6(&mut self) -> TpccAInt6W<DssTpccAIntaggStatusRawSpec> {
...
Raw Status of Interrupt from DSS_TPCC_A. Set irrespective if the Interupt is masked or unmasked in DSS_TPCC_A_INTAGG_MASK"]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_int7(&mut self) -> TpccAInt7W<DssTpccAIntaggStatusRawSpec> {
...
Raw Status of Interrupt from DSS_TPTC_A0. Set irrespective if the Interupt is masked or unmasked in DSS_TPCC_A_INTAGG_MASK"]
    #[inline(always)]
    #[must_use]
    pub fn tptc_a0(&mut self) -> TptcA0W<DssTpccAIntaggStatusRawSpec> {
        TptcA0W::new(self, 16)
    }
    #[doc = "Bit 17 - 17:17\\]
Raw Status of Interrupt from DSS_TPTC_A1. Set irrespective if the Interupt is masked or unmasked in DSS_TPCC_A_INTAGG_MASK"]
    #[inline(always)]
    #[must_use]
    pub fn tptc_a1(&mut self) -> TptcA1W<DssTpccAIntaggStatusRawSpec> {
        TptcA1W::new(self, 17)
    }
}
#[doc = "DSS_TPCC_A_INTAGG_STATUS_RAW\n\nYou can [`read`](crate::Reg::read) this register and get [`dss_tpcc_a_intagg_status_raw::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dss_tpcc_a_intagg_status_raw::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DssTpccAIntaggStatusRawSpec;
impl crate::RegisterSpec for DssTpccAIntaggStatusRawSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dss_tpcc_a_intagg_status_raw::R`](R) reader structure"]
impl crate::Readable for DssTpccAIntaggStatusRawSpec {}
#[doc = "`write(|w| ..)` method takes [`dss_tpcc_a_intagg_status_raw::W`](W) writer structure"]
impl crate::Writable for DssTpccAIntaggStatusRawSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DSS_TPCC_A_INTAGG_STATUS_RAW to value 0"]
impl crate::Resettable for DssTpccAIntaggStatusRawSpec {
