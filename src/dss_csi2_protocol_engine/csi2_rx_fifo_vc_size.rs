#[doc = "Register `CSI2_RX_FIFO_VC_SIZE` reader"]
pub type R = crate::R<Csi2RxFifoVcSizeSpec>;
#[doc = "Register `CSI2_RX_FIFO_VC_SIZE` writer"]
pub type W = crate::W<Csi2RxFifoVcSizeSpec>;
...
Address of the space allocated in the FIFO for virtual channel 0.The valid values are from 0 to 7 for a size of the FIFO of 256x33bits corresponding to 0, 32, 64,... for the entry address."]
    #[inline(always)]
    #[must_use]
    pub fn vc0_fifo_add(&mut self) -> Vc0FifoAddW<Csi2RxFifoVcSizeSpec> {
...
Size of the FIFO allocated for virtual channel 0.The valid values are from 0 to 8 for a size of the FIFO of 256x33bits corresponding to 0x33bits, 32x33bits, 64x33bits..."]
    #[inline(always)]
    #[must_use]
    pub fn vc0_fifo_size(&mut self) -> Vc0FifoSizeW<Csi2RxFifoVcSizeSpec> {
...
Address of the space allocated in the FIFO for virtual channel 1.The valid values are from 0 to 7 for a size of the FIFO of 256x33bits corresponding to 0, 32, 64,... for the entry address."]
    #[inline(always)]
    #[must_use]
    pub fn vc1_fifo_add(&mut self) -> Vc1FifoAddW<Csi2RxFifoVcSizeSpec> {
        Vc1FifoAddW::new(self, 8)
    }
    #[doc = "Bit 11"]
    #[inline(always)]
    #[must_use]
    pub fn reserved1(&mut self) -> Reserved1W<Csi2RxFifoVcSizeSpec> {
...
Size of the FIFO allocated for virtual channel 1.The valid values are from 0 to 8 for a size of the FIFO of 256x33bits corresponding to 0x33bits, 32x33bits, 64x33bits..."]
    #[inline(always)]
    #[must_use]
    pub fn vc1_fifo_size(&mut self) -> Vc1FifoSizeW<Csi2RxFifoVcSizeSpec> {
...
Address of the space allocated in the FIFO for virtual channel 2.The valid values are from 0 to 7 for a size of the FIFO of 256x33bits corresponding to 0, 32, 64,... for the entry address."]
    #[inline(always)]
    #[must_use]
    pub fn vc2_fifo_add(&mut self) -> Vc2FifoAddW<Csi2RxFifoVcSizeSpec> {
        Vc2FifoAddW::new(self, 16)
    }
    #[doc = "Bit 19"]
    #[inline(always)]
    #[must_use]
    pub fn reserved3(&mut self) -> Reserved3W<Csi2RxFifoVcSizeSpec> {
...
Size of the FIFO allocated for virtual channel 2.The valid values are from 0 to 8 for a size of the FIFO of 256x33bits corresponding to 0x33bits, 32x33bits, 64x33bits..."]
    #[inline(always)]
    #[must_use]
    pub fn vc2_fifo_size(&mut self) -> Vc2FifoSizeW<Csi2RxFifoVcSizeSpec> {
...
Address of the space allocated in the FIFO for virtual channel 3.The valid values are from 0 to 7 for a size of the FIFO of 256x33bits corresponding to 0, 32, 64,... for the entry address."]
    #[inline(always)]
    #[must_use]
    pub fn vc3_fifo_add(&mut self) -> Vc3FifoAddW<Csi2RxFifoVcSizeSpec> {
        Vc3FifoAddW::new(self, 24)
    }
    #[doc = "Bit 27"]
    #[inline(always)]
    #[must_use]
    pub fn reserved2(&mut self) -> Reserved2W<Csi2RxFifoVcSizeSpec> {
...
Size of the FIFO allocated for virtual channel 3.The valid values are from 0 to 8 for a size of the FIFO of 256x33bits corresponding to 0x33bits, 32x33bits, 64x33bits..."]
    #[inline(always)]
    #[must_use]
    pub fn vc3_fifo_size(&mut self) -> Vc3FifoSizeW<Csi2RxFifoVcSizeSpec> {
        Vc3FifoSizeW::new(self, 28)
    }
}
#[doc = "Defines the corresponding memory entries allocated for each virtual channel and the addresses. The virtual channel shall be disabled in order to allocate/un-allocate some entries in the RX FIFO.\n\nYou can [`read`](crate::Reg::read) this register and get [`csi2_rx_fifo_vc_size::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`csi2_rx_fifo_vc_size::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Csi2RxFifoVcSizeSpec;
impl crate::RegisterSpec for Csi2RxFifoVcSizeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`csi2_rx_fifo_vc_size::R`](R) reader structure"]
impl crate::Readable for Csi2RxFifoVcSizeSpec {}
#[doc = "`write(|w| ..)` method takes [`csi2_rx_fifo_vc_size::W`](W) writer structure"]
impl crate::Writable for Csi2RxFifoVcSizeSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CSI2_RX_FIFO_VC_SIZE to value 0"]
impl crate::Resettable for Csi2RxFifoVcSizeSpec {
