#[doc = "Register `CSI2_VC_IRQSTATUS_0` reader"]
pub type R = crate::R<Csi2VcIrqstatus0Spec>;
#[doc = "Register `CSI2_VC_IRQSTATUS_0` writer"]
pub type W = crate::W<Csi2VcIrqstatus0Spec>;
#[doc = "0:0\\]
...
Virtual channel - Check-Sum mismatch status."]
    #[inline(always)]
    #[must_use]
    pub fn cs_irq(&mut self) -> CsIrqW<Csi2VcIrqstatus0Spec> {
        CsIrqW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Virtual channel - ECC has been used to do the correction of the only 1-bit error status (short and long packet)."]
    #[inline(always)]
    #[must_use]
    pub fn ecc_correction_irq(&mut self) -> EccCorrectionIrqW<Csi2VcIrqstatus0Spec> {
...
Indicates that a packet has been sent. It is used when BTA manual mode is used."]
    #[inline(always)]
    #[must_use]
    pub fn packet_sent_irq(&mut self) -> PacketSentIrqW<Csi2VcIrqstatus0Spec> {
...
FIFO overflow error status. The FIFO used on the slave port for buffering the data received on the OCP slave port for the virtual channel has overflowed."]
    #[inline(always)]
    #[must_use]
    pub fn fifo_tx_ovf_irq(&mut self) -> FifoTxOvfIrqW<Csi2VcIrqstatus0Spec> {
...
FIFO overflow error status. The FIFO used on the slave port for buffering the data received on the CSI2 link for the virtual channel has overflowed."]
    #[inline(always)]
    #[must_use]
    pub fn fifo_rx_ovf_irq(&mut self) -> FifoRxOvfIrqW<Csi2VcIrqstatus0Spec> {
...
Virtual channel - BTA status."]
    #[inline(always)]
    #[must_use]
    pub fn bta_irq(&mut self) -> BtaIrqW<Csi2VcIrqstatus0Spec> {
        BtaIrqW::new(self, 5)
    }
    #[doc = "Bit 6 - 6:6\\]
ECC error status (short and long packets). No correction of the header because of more than 1-bit error."]
    #[inline(always)]
    #[must_use]
    pub fn ecc_no_correction_irq(&mut self) -> EccNoCorrectionIrqW<Csi2VcIrqstatus0Spec> {
...
FIFO underflow status. The FIFO used on the slave port for buffering the data received on the OCP slave port for the virtual channel has underflowed which means that the data for the current packet have not been received in time since the transfer of the packet are already started (transfer started since the packet size is bigger than space allocated in the FIFO)."]
    #[inline(always)]
    #[must_use]
    pub fn fifo_tx_udf_irq(&mut self) -> FifoTxUdfIrqW<Csi2VcIrqstatus0Spec> {
...
Video Port ping-pong buffer busy status. PP_BUSY has changed from 1 to 0."]
    #[inline(always)]
    #[must_use]
    pub fn pp_busy_change_irq(&mut self) -> PpBusyChangeIrqW<Csi2VcIrqstatus0Spec> {
        PpBusyChangeIrqW::new(self, 8)
    }
}
#[doc = "INTERRUPT STATUS REGISTER - Virtual channel This register regroups all the events related to the virtual channel.\n\nYou can [`read`](crate::Reg::read) this register and get [`csi2_vc_irqstatus_0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`csi2_vc_irqstatus_0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Csi2VcIrqstatus0Spec;
impl crate::RegisterSpec for Csi2VcIrqstatus0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`csi2_vc_irqstatus_0::R`](R) reader structure"]
impl crate::Readable for Csi2VcIrqstatus0Spec {}
#[doc = "`write(|w| ..)` method takes [`csi2_vc_irqstatus_0::W`](W) writer structure"]
impl crate::Writable for Csi2VcIrqstatus0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CSI2_VC_IRQSTATUS_0 to value 0"]
impl crate::Resettable for Csi2VcIrqstatus0Spec {
