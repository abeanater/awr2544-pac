#[doc = "Register `CSI2_VC_TE_2` reader"]
pub type R = crate::R<Csi2VcTe2Spec>;
#[doc = "Register `CSI2_VC_TE_2` writer"]
pub type W = crate::W<Csi2VcTe2Spec>;
...
Defines the number of byte (payload data excluding the check -sum) to be sent. The write into the register CSI2_VC_LONG_PACKET_HEADER shall be performed by the user before sending data from the register CSI2_VC_LONG_PACKET_PAYLOAD. The register value is decremented for every byte sent of the CSI2 link. At the end of the transfer (TE_SIZE=0), the bit-field TE_EN is reset by HW. The DMA_request shall be asserted when the trigger is received in order to receive data in the TX FIFO. It shall not be used until all data (TE_SIZE) have been received in the FIFO."]
    #[inline(always)]
    #[must_use]
    pub fn te_size(&mut self) -> TeSizeW<Csi2VcTe2Spec> {
        TeSizeW::new(self, 0)
    }
    #[doc = "Bit 28 - 28:28\\]
Selection between TE0 and TE1 cmos signals."]
    #[inline(always)]
    #[must_use]
    pub fn te_line_nb(&mut self) -> TeLineNbW<Csi2VcTe2Spec> {
        TeLineNbW::new(self, 28)
    }
    #[doc = "Bit 29"]
    #[inline(always)]
    #[must_use]
    pub fn te_line(&mut self) -> TeLineW<Csi2VcTe2Spec> {
        TeLineW::new(self, 29)
    }
    #[doc = "Bit 30 - 30:30\\]
Tearing Effect Control"]
    #[inline(always)]
    #[must_use]
    pub fn te_en(&mut self) -> TeEnW<Csi2VcTe2Spec> {
        TeEnW::new(self, 30)
    }
    #[doc = "Bit 31 - 31:31\\]
Manual control of the start of the transfer. The user can use the TE interrupt in order to know that the TE trigger has been received prior to set the TE_START bit-field. It is not mandatory to use the TE interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn te_start(&mut self) -> TeStartW<Csi2VcTe2Spec> {
        TeStartW::new(self, 31)
    }
}
#[doc = "CONTROL REGISTER - Virtual channel This register controls the tearing effect logic. It defines the size of the transfer when TE occurs and enables the automatic TE mode.\n\nYou can [`read`](crate::Reg::read) this register and get [`csi2_vc_te_2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`csi2_vc_te_2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Csi2VcTe2Spec;
impl crate::RegisterSpec for Csi2VcTe2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`csi2_vc_te_2::R`](R) reader structure"]
impl crate::Readable for Csi2VcTe2Spec {}
#[doc = "`write(|w| ..)` method takes [`csi2_vc_te_2::W`](W) writer structure"]
impl crate::Writable for Csi2VcTe2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CSI2_VC_TE_2 to value 0"]
impl crate::Resettable for Csi2VcTe2Spec {
