#[doc = "Register `CSI2_VC_CTRL_3` reader"]
pub type R = crate::R<Csi2VcCtrl3Spec>;
#[doc = "Register `CSI2_VC_CTRL_3` writer"]
pub type W = crate::W<Csi2VcCtrl3Spec>;
#[doc = "0:0\\]
...
Enables the virtual channel."]
    #[inline(always)]
    #[must_use]
    pub fn vc_en(&mut self) -> VcEnW<Csi2VcCtrl3Spec> {
        VcEnW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Selection of the source between OCP and the Video port(s) (used by the HW only if MODE=COMMAND MODE (0x0) otherwise it is ignored). The number of available video ports is defined in CSI2_GNQ.NB_VIDEO_PORTS."]
    #[inline(always)]
    #[must_use]
    pub fn source(&mut self) -> SourceW<Csi2VcCtrl3Spec> {
        SourceW::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
Enables the automatic bus turn-around after completion of each short packet transmission."]
    #[inline(always)]
    #[must_use]
    pub fn bta_short_en(&mut self) -> BtaShortEnW<Csi2VcCtrl3Spec> {
...
Enables the automatic bus turn-around after completion of each long packet transmission."]
    #[inline(always)]
    #[must_use]
    pub fn bta_long_en(&mut self) -> BtaLongEnW<Csi2VcCtrl3Spec> {
...
Selection of the mode"]
    #[inline(always)]
    #[must_use]
    pub fn mode(&mut self) -> ModeW<Csi2VcCtrl3Spec> {
        ModeW::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
FIFO status"]
    #[inline(always)]
    #[must_use]
    pub fn tx_fifo_not_empty(&mut self) -> TxFifoNotEmptyW<Csi2VcCtrl3Spec> {
...
Send the bus turn around to the peripheral. It can be used when the automatic mode is enabled (BTA_SHORT_EN=1 or/and BTA_LONG_EN=1). In that case only one BTA is sent to the peripheral. The manual mode is used to allow the user to define for which packets, the turn around is required for example getting acknowledge from the peripheral."]
    #[inline(always)]
    #[must_use]
    pub fn bta_en(&mut self) -> BtaEnW<Csi2VcCtrl3Spec> {
        BtaEnW::new(self, 6)
    }
    #[doc = "Bit 7 - 7:7\\]
Enables the checksum generation for the transmit payload (long packet only)."]
    #[inline(always)]
    #[must_use]
    pub fn cs_tx_en(&mut self) -> CsTxEnW<Csi2VcCtrl3Spec> {
        CsTxEnW::new(self, 7)
    }
    #[doc = "Bit 8 - 8:8\\]
Enables the Error Correction Code generation for the transmit header (short and long packets)."]
    #[inline(always)]
    #[must_use]
    pub fn ecc_tx_en(&mut self) -> EccTxEnW<Csi2VcCtrl3Spec> {
        EccTxEnW::new(self, 8)
    }
    #[doc = "Bit 9 - 9:9\\]
Selection of the mode. The information is used by HW only if MODE=COMMAND_MODE otherwise it is ignored."]
    #[inline(always)]
    #[must_use]
    pub fn mode_speed(&mut self) -> ModeSpeedW<Csi2VcCtrl3Spec> {
...
Defines the size of the OCP data bus"]
    #[inline(always)]
    #[must_use]
    pub fn ocp_data_bus_width(&mut self) -> OcpDataBusWidthW<Csi2VcCtrl3Spec> {
...
Byte order for RBG565"]
    #[inline(always)]
    #[must_use]
    pub fn rgb565_order(&mut self) -> Rgb565OrderW<Csi2VcCtrl3Spec> {
...
Selection between video port 1 and video port 2. If CSI2_GNQ.NB_VIDEO_PORTS=0, the bit-field is ignored since only video port 1 is present."]
    #[inline(always)]
    #[must_use]
    pub fn vp_source(&mut self) -> VpSourceW<Csi2VcCtrl3Spec> {
...
Ping-pong buffer busy status."]
    #[inline(always)]
    #[must_use]
    pub fn pp_busy(&mut self) -> PpBusyW<Csi2VcCtrl3Spec> {
        PpBusyW::new(self, 14)
    }
    #[doc = "Bit 15 - 15:15\\]
Indicates if previously scheduled activities (packets, BTA) are still being processed. Forced to 1 if VC is enabled. Software should check this bit is 0 before changing channel configuration."]
    #[inline(always)]
    #[must_use]
    pub fn vc_busy(&mut self) -> VcBusyW<Csi2VcCtrl3Spec> {
        VcBusyW::new(self, 15)
    }
    #[doc = "Bit 16 - 16:16\\]
FIFO status"]
    #[inline(always)]
    #[must_use]
    pub fn tx_fifo_full(&mut self) -> TxFifoFullW<Csi2VcCtrl3Spec> {
...
Defines the threshold value for the DMA request (associated to the TX FIFO)"]
    #[inline(always)]
    #[must_use]
    pub fn dma_tx_threshold(&mut self) -> DmaTxThresholdW<Csi2VcCtrl3Spec> {
...
FIFO status"]
    #[inline(always)]
    #[must_use]
    pub fn rx_fifo_not_empty(&mut self) -> RxFifoNotEmptyW<Csi2VcCtrl3Spec> {
...
Selection of the use of the DMA request (associated to the TX FIFO)"]
    #[inline(always)]
    #[must_use]
    pub fn dma_tx_req_nb(&mut self) -> DmaTxReqNbW<Csi2VcCtrl3Spec> {
...
Defines the threshold value for the DMA request (associated to the RX FIFO)"]
    #[inline(always)]
    #[must_use]
    pub fn dma_rx_threshold(&mut self) -> DmaRxThresholdW<Csi2VcCtrl3Spec> {
...
Selection of the use of the DMA request (associated to the RX FIFO)"]
    #[inline(always)]
    #[must_use]
    pub fn dma_rx_req_nb(&mut self) -> DmaRxReqNbW<Csi2VcCtrl3Spec> {
...
Enables automatic insertion of DCS command codes when data is sourced by the video port."]
    #[inline(always)]
    #[must_use]
    pub fn dcs_cmd_enable(&mut self) -> DcsCmdEnableW<Csi2VcCtrl3Spec> {
...
DCS command code value to insert between header and video port or OCP slave data when enabled by DCS_CMD_ENABLE (only when TE mechanism is not used otherwise the bit-field DCS_CMD_CODE is ignored by CSI2 protocol engine)."]
    #[inline(always)]
    #[must_use]
    pub fn dcs_cmd_code(&mut self) -> DcsCmdCodeW<Csi2VcCtrl3Spec> {
        DcsCmdCodeW::new(self, 31)
    }
}
#[doc = "CONTROL REGISTER - Virtual channel This register controls the virtual channel.\n\nYou can [`read`](crate::Reg::read) this register and get [`csi2_vc_ctrl_3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`csi2_vc_ctrl_3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Csi2VcCtrl3Spec;
impl crate::RegisterSpec for Csi2VcCtrl3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`csi2_vc_ctrl_3::R`](R) reader structure"]
impl crate::Readable for Csi2VcCtrl3Spec {}
#[doc = "`write(|w| ..)` method takes [`csi2_vc_ctrl_3::W`](W) writer structure"]
impl crate::Writable for Csi2VcCtrl3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CSI2_VC_CTRL_3 to value 0"]
impl crate::Resettable for Csi2VcCtrl3Spec {
