#[doc = "Register `CSI2_VC_IRQENABLE_1` reader"]
pub type R = crate::R<Csi2VcIrqenable1Spec>;
#[doc = "Register `CSI2_VC_IRQENABLE_1` writer"]
pub type W = crate::W<Csi2VcIrqenable1Spec>;
#[doc = "0:0\\]
...
Virtual channel - Check-Sum of the payload mismatch detection"]
    #[inline(always)]
    #[must_use]
    pub fn cs_irq_en(&mut self) -> CsIrqEnW<Csi2VcIrqenable1Spec> {
        CsIrqEnW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Virtual channel - ECC has been used to correct the only 1-bit error (short and long packet)."]
    #[inline(always)]
    #[must_use]
    pub fn ecc_correction_irq_en(&mut self) -> EccCorrectionIrqEnW<Csi2VcIrqenable1Spec> {
...
Indicates that a packet has been sent. It is used when BTA manual mode is used."]
    #[inline(always)]
    #[must_use]
    pub fn packet_sent_irq_en(&mut self) -> PacketSentIrqEnW<Csi2VcIrqenable1Spec> {
...
FIFO overflow enable. The FIFO used on the slave port for buffering the data received on the OCP slave port for the virtual channel has overflowed."]
    #[inline(always)]
    #[must_use]
    pub fn fifo_tx_ovf_irq_en(&mut self) -> FifoTxOvfIrqEnW<Csi2VcIrqenable1Spec> {
...
FIFO overflow enable. The FIFO used on the slave port for buffering the data received on the CSI2 link for the virtual channel has overflowed."]
    #[inline(always)]
    #[must_use]
    pub fn fifo_rx_ovf_irq_en(&mut self) -> FifoRxOvfIrqEnW<Csi2VcIrqenable1Spec> {
...
Virtual channel -Bus turn around reception"]
    #[inline(always)]
    #[must_use]
    pub fn bta_irq_en(&mut self) -> BtaIrqEnW<Csi2VcIrqenable1Spec> {
...
ECC error (short and long packets). No correction of the header because of more than 1-bit error."]
    #[inline(always)]
    #[must_use]
    pub fn ecc_no_correction_irq_en(&mut self) -> EccNoCorrectionIrqEnW<Csi2VcIrqenable1Spec> {
...
FIFO underflow enable. The FIFO used on the slave port for buffering the data received on the OCP slave port for the virtual channel has underflowed which means that the data for the current packet have not been received in time since the transfer of the packet are already started (transfer started since the packet size is bigger than space allocated in the FIFO)."]
    #[inline(always)]
    #[must_use]
    pub fn fifo_tx_udf_irq_en(&mut self) -> FifoTxUdfIrqEnW<Csi2VcIrqenable1Spec> {
...
Video Port ping-pong buffer busy status."]
    #[inline(always)]
    #[must_use]
    pub fn pp_busy_change_irq_en(&mut self) -> PpBusyChangeIrqEnW<Csi2VcIrqenable1Spec> {
        PpBusyChangeIrqEnW::new(self, 8)
    }
}
#[doc = "INTERRUPT ENABLE REGISTER - Virtual channel This register regroups all the events related to virtual channel.\n\nYou can [`read`](crate::Reg::read) this register and get [`csi2_vc_irqenable_1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`csi2_vc_irqenable_1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Csi2VcIrqenable1Spec;
impl crate::RegisterSpec for Csi2VcIrqenable1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`csi2_vc_irqenable_1::R`](R) reader structure"]
impl crate::Readable for Csi2VcIrqenable1Spec {}
#[doc = "`write(|w| ..)` method takes [`csi2_vc_irqenable_1::W`](W) writer structure"]
impl crate::Writable for Csi2VcIrqenable1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CSI2_VC_IRQENABLE_1 to value 0"]
impl crate::Resettable for Csi2VcIrqenable1Spec {
