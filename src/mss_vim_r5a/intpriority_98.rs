#[doc = "Register `INTPRIORITY_98` reader"]
pub type R = crate::R<Intpriority98Spec>;
#[doc = "Register `INTPRIORITY_98` writer"]
pub type W = crate::W<Intpriority98Spec>;
...
This is the priority for interrupt Q. If two interrupts have the same priority, then whichever interrupt has the lower number Q wins arbitration 0 Highest Priority 15 Lowest Priority (Default)"]
    #[inline(always)]
    #[must_use]
    pub fn pri(&mut self) -> PriW<Intpriority98Spec> {
        PriW::new(self, 0)
    }
    #[doc = "Bits 4:31 - 31:4\\]
RESERVE FIELD"]
    #[inline(always)]
    #[must_use]
    pub fn res19(&mut self) -> Res19W<Intpriority98Spec> {
        Res19W::new(self, 4)
    }
}
...
pub struct Intpriority98Spec;
impl crate::RegisterSpec for Intpriority98Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`intpriority_98::R`](R) reader structure"]
impl crate::Readable for Intpriority98Spec {}
#[doc = "`write(|w| ..)` method takes [`intpriority_98::W`](W) writer structure"]
impl crate::Writable for Intpriority98Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets INTPRIORITY_98 to value 0"]
impl crate::Resettable for Intpriority98Spec {
