#[doc = "Register `INTPRIORITY_178` reader"]
pub type R = crate::R<Intpriority178Spec>;
#[doc = "Register `INTPRIORITY_178` writer"]
pub type W = crate::W<Intpriority178Spec>;
...
This is the priority for interrupt Q. If two interrupts have the same priority, then whichever interrupt has the lower number Q wins arbitration 0 Highest Priority 15 Lowest Priority (Default)"]
    #[inline(always)]
    #[must_use]
    pub fn pri(&mut self) -> PriW<Intpriority178Spec> {
        PriW::new(self, 0)
    }
    #[doc = "Bits 4:31 - 31:4\\]
RESERVE FIELD"]
    #[inline(always)]
    #[must_use]
    pub fn res19(&mut self) -> Res19W<Intpriority178Spec> {
        Res19W::new(self, 4)
    }
}
...
pub struct Intpriority178Spec;
impl crate::RegisterSpec for Intpriority178Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`intpriority_178::R`](R) reader structure"]
impl crate::Readable for Intpriority178Spec {}
#[doc = "`write(|w| ..)` method takes [`intpriority_178::W`](W) writer structure"]
impl crate::Writable for Intpriority178Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets INTPRIORITY_178 to value 0"]
impl crate::Resettable for Intpriority178Spec {
