#[doc = "Register `INTPRIORITY_164` reader"]
pub type R = crate::R<Intpriority164Spec>;
#[doc = "Register `INTPRIORITY_164` writer"]
pub type W = crate::W<Intpriority164Spec>;
...
This is the priority for interrupt Q. If two interrupts have the same priority, then whichever interrupt has the lower number Q wins arbitration 0 Highest Priority 15 Lowest Priority (Default)"]
    #[inline(always)]
    #[must_use]
    pub fn pri(&mut self) -> PriW<Intpriority164Spec> {
        PriW::new(self, 0)
    }
    #[doc = "Bits 4:31 - 31:4\\]
RESERVE FIELD"]
    #[inline(always)]
    #[must_use]
    pub fn res19(&mut self) -> Res19W<Intpriority164Spec> {
        Res19W::new(self, 4)
    }
}
...
pub struct Intpriority164Spec;
impl crate::RegisterSpec for Intpriority164Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`intpriority_164::R`](R) reader structure"]
impl crate::Readable for Intpriority164Spec {}
#[doc = "`write(|w| ..)` method takes [`intpriority_164::W`](W) writer structure"]
impl crate::Writable for Intpriority164Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets INTPRIORITY_164 to value 0"]
impl crate::Resettable for Intpriority164Spec {
