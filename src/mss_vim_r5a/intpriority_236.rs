#[doc = "Register `INTPRIORITY_236` reader"]
pub type R = crate::R<Intpriority236Spec>;
#[doc = "Register `INTPRIORITY_236` writer"]
pub type W = crate::W<Intpriority236Spec>;
...
This is the priority for interrupt Q. If two interrupts have the same priority, then whichever interrupt has the lower number Q wins arbitration 0 Highest Priority 15 Lowest Priority (Default)"]
    #[inline(always)]
    #[must_use]
    pub fn pri(&mut self) -> PriW<Intpriority236Spec> {
        PriW::new(self, 0)
    }
    #[doc = "Bits 4:31 - 31:4\\]
RESERVE FIELD"]
    #[inline(always)]
    #[must_use]
    pub fn res19(&mut self) -> Res19W<Intpriority236Spec> {
        Res19W::new(self, 4)
    }
}
...
pub struct Intpriority236Spec;
impl crate::RegisterSpec for Intpriority236Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`intpriority_236::R`](R) reader structure"]
impl crate::Readable for Intpriority236Spec {}
#[doc = "`write(|w| ..)` method takes [`intpriority_236::W`](W) writer structure"]
impl crate::Writable for Intpriority236Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets INTPRIORITY_236 to value 0"]
impl crate::Resettable for Intpriority236Spec {
