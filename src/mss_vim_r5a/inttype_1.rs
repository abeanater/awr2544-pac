#[doc = "Register `INTTYPE_1` reader"]
pub type R = crate::R<Inttype1Spec>;
#[doc = "Register `INTTYPE_1` writer"]
...
This field is used to indicate whether the source of an interrupt is a level (default) or a pulse for event group M. This is informational so that an ISR may query this register and know whether it has to clear a pulse event or a level event (see 3.4 Interrupt Handling). The value has no effect on how the VIM hardware functions. The input interrupts are agnostic as to whether they are pulse or level. Each bit corresponds to event Q where Q = Mx32+Bit 0 Level (default) 1 Pulse"]
    #[inline(always)]
    #[must_use]
    pub fn val(&mut self) -> ValW<Inttype1Spec> {
        ValW::new(self, 0)
    }
}
#[doc = "Group M Type Map Register (M is 0 to 7) h400 + M x h20 + 0x1C\n\nYou can [`read`](crate::Reg::read) this register and get [`inttype_1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`inttype_1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Inttype1Spec;
impl crate::RegisterSpec for Inttype1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`inttype_1::R`](R) reader structure"]
impl crate::Readable for Inttype1Spec {}
#[doc = "`write(|w| ..)` method takes [`inttype_1::W`](W) writer structure"]
impl crate::Writable for Inttype1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets INTTYPE_1 to value 0"]
