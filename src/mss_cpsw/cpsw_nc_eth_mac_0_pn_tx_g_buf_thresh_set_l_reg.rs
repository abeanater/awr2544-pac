#[doc = "Register `CPSW_NC_ETH_MAC_0_PN_TX_G_BUF_THRESH_SET_L_REG` reader"]
pub type R = crate::R<CpswNcEthMac0PnTxGBufThreshSetLRegSpec>;
#[doc = "Register `CPSW_NC_ETH_MAC_0_PN_TX_G_BUF_THRESH_SET_L_REG` writer"]
pub type W = crate::W<CpswNcEthMac0PnTxGBufThreshSetLRegSpec>;
...
Port Priority Based Flow Control Threshold Set Value for Priority 0"]
    ...
    pub fn port_priority_based_3(
        &mut self,
    ) -> PortPriorityBased3W<CpswNcEthMac0PnTxGBufThreshSetLRegSpec> {
...
Port Priority Based Flow Control Threshold Set Value for Priority 1"]
    ...
    pub fn port_priority_based_2(
        &mut self,
    ) -> PortPriorityBased2W<CpswNcEthMac0PnTxGBufThreshSetLRegSpec> {
...
Port Priority Based Flow Control Threshold Set Value for Priority 2"]
    ...
    pub fn port_priority_based_1(
        &mut self,
    ) -> PortPriorityBased1W<CpswNcEthMac0PnTxGBufThreshSetLRegSpec> {
...
Port Priority Based Flow Control Threshold Set Value for Priority 3"]
    ...
    pub fn port_priority_based(
        &mut self,
    ) -> PortPriorityBasedW<CpswNcEthMac0PnTxGBufThreshSetLRegSpec> {
        PortPriorityBasedW::new(self, 24)
    }
}
#[doc = "Enet Port N Tx PFC Global Buffer Threshold Set Low\n\nYou can [`read`](crate::Reg::read) this register and get [`cpsw_nc_eth_mac_0_pn_tx_g_buf_thresh_set_l_reg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cpsw_nc_eth_mac_0_pn_tx_g_buf_thresh_set_l_reg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CpswNcEthMac0PnTxGBufThreshSetLRegSpec;
impl crate::RegisterSpec for CpswNcEthMac0PnTxGBufThreshSetLRegSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cpsw_nc_eth_mac_0_pn_tx_g_buf_thresh_set_l_reg::R`](R) reader structure"]
impl crate::Readable for CpswNcEthMac0PnTxGBufThreshSetLRegSpec {}
#[doc = "`write(|w| ..)` method takes [`cpsw_nc_eth_mac_0_pn_tx_g_buf_thresh_set_l_reg::W`](W) writer structure"]
impl crate::Writable for CpswNcEthMac0PnTxGBufThreshSetLRegSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CPSW_NC_ETH_MAC_0_PN_TX_G_BUF_THRESH_SET_L_REG to value 0"]
impl crate::Resettable for CpswNcEthMac0PnTxGBufThreshSetLRegSpec {
