#[doc = "Register `CPSW_CPDMA_INT_CPDMA_TH_INTSTAT_MASKED_REG` reader"]
...
#[doc = "Field `CPDMA_RECEIVE_CHANNEL` writer - 15:15\\]
CPDMA Receive Channel 7 Threshold Interrupt Pending MASKED"]
...
CPDMA Receive Channel 7 Threshold Interrupt Pending MASKED"]
    ...
    pub fn cpdma_receive_channel(&self) -> CpdmaReceiveChannelR {
        CpdmaReceiveChannelR::new(((self.bits >> 15) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - 0:0\\]
...
CPDMA Receive Channel 7 Threshold Interrupt Pending MASKED"]
    ...
    pub fn cpdma_receive_channel(
        ...
        CpdmaReceiveChannelW::new(self, 15)
    }
}
#[doc = "CPDMA Receive Interrupt Status MASKED\n\nYou can [`read`](crate::Reg::read) this register and get [`cpsw_cpdma_int_cpdma_th_intstat_masked_reg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cpsw_cpdma_int_cpdma_th_intstat_masked_reg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CpswCpdmaIntCpdmaThIntstatMaskedRegSpec;
impl crate::RegisterSpec for CpswCpdmaIntCpdmaThIntstatMaskedRegSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cpsw_cpdma_int_cpdma_th_intstat_masked_reg::R`](R) reader structure"]
impl crate::Readable for CpswCpdmaIntCpdmaThIntstatMaskedRegSpec {}
#[doc = "`write(|w| ..)` method takes [`cpsw_cpdma_int_cpdma_th_intstat_masked_reg::W`](W) writer structure"]
impl crate::Writable for CpswCpdmaIntCpdmaThIntstatMaskedRegSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CPSW_CPDMA_INT_CPDMA_TH_INTSTAT_MASKED_REG to value 0"]
impl crate::Resettable for CpswCpdmaIntCpdmaThIntstatMaskedRegSpec {
