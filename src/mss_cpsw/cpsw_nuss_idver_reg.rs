#[doc = "Register `CPSW_NUSS_IDVER_REG` reader"]
pub type R = crate::R<CpswNussIdverRegSpec>;
#[doc = "Register `CPSW_NUSS_IDVER_REG` writer"]
pub type W = crate::W<CpswNussIdverRegSpec>;
...
Minor version value"]
    #[inline(always)]
    #[must_use]
    pub fn minor_version_value(&mut self) -> MinorVersionValueW<CpswNussIdverRegSpec> {
...
Major version value"]
    #[inline(always)]
    #[must_use]
    pub fn major_version_value(&mut self) -> MajorVersionValueW<CpswNussIdverRegSpec> {
...
RTL version value"]
    #[inline(always)]
    #[must_use]
    pub fn rtl_version_value(&mut self) -> RtlVersionValueW<CpswNussIdverRegSpec> {
...
Identification value"]
    #[inline(always)]
    #[must_use]
    pub fn identification_value(&mut self) -> IdentificationValueW<CpswNussIdverRegSpec> {
        IdentificationValueW::new(self, 16)
    }
}
#[doc = "ID Version Register\n\nYou can [`read`](crate::Reg::read) this register and get [`cpsw_nuss_idver_reg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cpsw_nuss_idver_reg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CpswNussIdverRegSpec;
impl crate::RegisterSpec for CpswNussIdverRegSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cpsw_nuss_idver_reg::R`](R) reader structure"]
impl crate::Readable for CpswNussIdverRegSpec {}
#[doc = "`write(|w| ..)` method takes [`cpsw_nuss_idver_reg::W`](W) writer structure"]
impl crate::Writable for CpswNussIdverRegSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CPSW_NUSS_IDVER_REG to value 0"]
impl crate::Resettable for CpswNussIdverRegSpec {
