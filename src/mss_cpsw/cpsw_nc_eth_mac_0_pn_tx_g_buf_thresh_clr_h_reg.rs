#[doc = "Register `CPSW_NC_ETH_MAC_0_PN_TX_G_BUF_THRESH_CLR_H_REG` reader"]
pub type R = crate::R<CpswNcEthMac0PnTxGBufThreshClrHRegSpec>;
#[doc = "Register `CPSW_NC_ETH_MAC_0_PN_TX_G_BUF_THRESH_CLR_H_REG` writer"]
pub type W = crate::W<CpswNcEthMac0PnTxGBufThreshClrHRegSpec>;
...
Port Priority Based Flow Control Threshold Clear Value for Priority 4"]
    ...
    pub fn port_priority_based_3(
        &mut self,
    ) -> PortPriorityBased3W<CpswNcEthMac0PnTxGBufThreshClrHRegSpec> {
...
Port Priority Based Flow Control Threshold Clear Value for Priority 5"]
    ...
    pub fn port_priority_based_2(
        &mut self,
    ) -> PortPriorityBased2W<CpswNcEthMac0PnTxGBufThreshClrHRegSpec> {
...
Port Priority Based Flow Control Threshold Clear Value for Priority 6"]
    ...
    pub fn port_priority_based_1(
        &mut self,
    ) -> PortPriorityBased1W<CpswNcEthMac0PnTxGBufThreshClrHRegSpec> {
...
Port Priority Based Flow Control Threshold Clear Value for Priority 7"]
    ...
    pub fn port_priority_based(
        &mut self,
    ) -> PortPriorityBasedW<CpswNcEthMac0PnTxGBufThreshClrHRegSpec> {
        PortPriorityBasedW::new(self, 24)
    }
}
#[doc = "Enet Port N Tx PFC Global Buffer Threshold Clr High\n\nYou can [`read`](crate::Reg::read) this register and get [`cpsw_nc_eth_mac_0_pn_tx_g_buf_thresh_clr_h_reg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cpsw_nc_eth_mac_0_pn_tx_g_buf_thresh_clr_h_reg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CpswNcEthMac0PnTxGBufThreshClrHRegSpec;
impl crate::RegisterSpec for CpswNcEthMac0PnTxGBufThreshClrHRegSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cpsw_nc_eth_mac_0_pn_tx_g_buf_thresh_clr_h_reg::R`](R) reader structure"]
impl crate::Readable for CpswNcEthMac0PnTxGBufThreshClrHRegSpec {}
#[doc = "`write(|w| ..)` method takes [`cpsw_nc_eth_mac_0_pn_tx_g_buf_thresh_clr_h_reg::W`](W) writer structure"]
impl crate::Writable for CpswNcEthMac0PnTxGBufThreshClrHRegSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CPSW_NC_ETH_MAC_0_PN_TX_G_BUF_THRESH_CLR_H_REG to value 0"]
impl crate::Resettable for CpswNcEthMac0PnTxGBufThreshClrHRegSpec {
