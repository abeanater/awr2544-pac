#[doc = "Register `CPSW_CPDMA_INT_CPDMA_FH_INTSTAT_MASKED_REG` reader"]
...
#[doc = "CPDMA FHost Interrupt Status MASKED\n\nYou can [`read`](crate::Reg::read) this register and get [`cpsw_cpdma_int_cpdma_fh_intstat_masked_reg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cpsw_cpdma_int_cpdma_fh_intstat_masked_reg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CpswCpdmaIntCpdmaFhIntstatMaskedRegSpec;
impl crate::RegisterSpec for CpswCpdmaIntCpdmaFhIntstatMaskedRegSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cpsw_cpdma_int_cpdma_fh_intstat_masked_reg::R`](R) reader structure"]
impl crate::Readable for CpswCpdmaIntCpdmaFhIntstatMaskedRegSpec {}
#[doc = "`write(|w| ..)` method takes [`cpsw_cpdma_int_cpdma_fh_intstat_masked_reg::W`](W) writer structure"]
impl crate::Writable for CpswCpdmaIntCpdmaFhIntstatMaskedRegSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CPSW_CPDMA_INT_CPDMA_FH_INTSTAT_MASKED_REG to value 0"]
impl crate::Resettable for CpswCpdmaIntCpdmaFhIntstatMaskedRegSpec {
