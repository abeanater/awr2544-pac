#[doc = "Register `CPSW_CPDMA_INT_CPDMA_FH_INTMASK_CLEAR_REG` reader"]
pub type R = crate::R<CpswCpdmaIntCpdmaFhIntmaskClearRegSpec>;
#[doc = "Register `CPSW_CPDMA_INT_CPDMA_FH_INTMASK_CLEAR_REG` writer"]
pub type W = crate::W<CpswCpdmaIntCpdmaFhIntmaskClearRegSpec>;
#[doc = "Field `CPDMA_FHOST_CHANNEL_7` reader - 0:0\\]
CPDMA FHost Channel 0 Interrupt Pending MASKED Clr"]
...
CPDMA FHost Channel 1 Interrupt Pending MASKED Clr"]
...
CPDMA FHost Channel 2 Interrupt Pending MASKED Clr"]
...
CPDMA FHost Channel 3 Interrupt Pending MASKED Clr"]
...
CPDMA FHost Channel 4 Interrupt Pending MASKED Clr"]
...
CPDMA FHost Channel 5 Interrupt Pending MASKED Clr"]
...
CPDMA FHost Channel 6 Interrupt Pending MASKED Clr"]
...
CPDMA FHost Channel 7 Interrupt Pending MASKED Clr"]
...
CPDMA FHost Channel 0 Interrupt Pending MASKED Clr"]
    ...
    pub fn cpdma_fhost_channel_7(
        &mut self,
    ) -> CpdmaFhostChannel7W<CpswCpdmaIntCpdmaFhIntmaskClearRegSpec> {
...
CPDMA FHost Channel 1 Interrupt Pending MASKED Clr"]
    ...
    pub fn cpdma_fhost_channel_6(
        &mut self,
    ) -> CpdmaFhostChannel6W<CpswCpdmaIntCpdmaFhIntmaskClearRegSpec> {
...
CPDMA FHost Channel 2 Interrupt Pending MASKED Clr"]
    ...
    pub fn cpdma_fhost_channel_5(
        &mut self,
    ) -> CpdmaFhostChannel5W<CpswCpdmaIntCpdmaFhIntmaskClearRegSpec> {
...
CPDMA FHost Channel 3 Interrupt Pending MASKED Clr"]
    ...
    pub fn cpdma_fhost_channel_4(
        &mut self,
    ) -> CpdmaFhostChannel4W<CpswCpdmaIntCpdmaFhIntmaskClearRegSpec> {
...
CPDMA FHost Channel 4 Interrupt Pending MASKED Clr"]
    ...
    pub fn cpdma_fhost_channel_3(
        &mut self,
    ) -> CpdmaFhostChannel3W<CpswCpdmaIntCpdmaFhIntmaskClearRegSpec> {
...
CPDMA FHost Channel 5 Interrupt Pending MASKED Clr"]
    ...
    pub fn cpdma_fhost_channel_2(
        &mut self,
    ) -> CpdmaFhostChannel2W<CpswCpdmaIntCpdmaFhIntmaskClearRegSpec> {
...
CPDMA FHost Channel 6 Interrupt Pending MASKED Clr"]
    ...
    pub fn cpdma_fhost_channel_1(
        &mut self,
    ) -> CpdmaFhostChannel1W<CpswCpdmaIntCpdmaFhIntmaskClearRegSpec> {
...
CPDMA FHost Channel 7 Interrupt Pending MASKED Clr"]
    ...
    pub fn cpdma_fhost_channel(
        &mut self,
    ) -> CpdmaFhostChannelW<CpswCpdmaIntCpdmaFhIntmaskClearRegSpec> {
        CpdmaFhostChannelW::new(self, 7)
    }
}
#[doc = "CPDMA FHost Interrupt Masked CLR\n\nYou can [`read`](crate::Reg::read) this register and get [`cpsw_cpdma_int_cpdma_fh_intmask_clear_reg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cpsw_cpdma_int_cpdma_fh_intmask_clear_reg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CpswCpdmaIntCpdmaFhIntmaskClearRegSpec;
impl crate::RegisterSpec for CpswCpdmaIntCpdmaFhIntmaskClearRegSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cpsw_cpdma_int_cpdma_fh_intmask_clear_reg::R`](R) reader structure"]
impl crate::Readable for CpswCpdmaIntCpdmaFhIntmaskClearRegSpec {}
#[doc = "`write(|w| ..)` method takes [`cpsw_cpdma_int_cpdma_fh_intmask_clear_reg::W`](W) writer structure"]
impl crate::Writable for CpswCpdmaIntCpdmaFhIntmaskClearRegSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CPSW_CPDMA_INT_CPDMA_FH_INTMASK_CLEAR_REG to value 0"]
impl crate::Resettable for CpswCpdmaIntCpdmaFhIntmaskClearRegSpec {
