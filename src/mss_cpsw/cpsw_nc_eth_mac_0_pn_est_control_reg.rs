...
#[doc = "Field `TRANSMIT_FIFO_EST` reader - 0:0\\]
Transmit FIFO EST One Buffer"]
pub type TransmitFifoEstR = crate::BitReader;
#[doc = "Field `TRANSMIT_FIFO_EST` writer - 0:0\\]
Transmit FIFO EST One Buffer"]
pub type TransmitFifoEstW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TRANSMIT_FIFO_EST` reader - 1:1\\]
Transmit FIFO EST Buffer Select"]
pub type TransmitFifoEstR = crate::BitReader;
#[doc = "Field `TRANSMIT_FIFO_EST` writer - 1:1\\]
Transmit FIFO EST Buffer Select"]
pub type TransmitFifoEstW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TRANSMIT_FIFO_EST` reader - 2:2\\]
Transmit FIFO EST TimeStamp Enable"]
pub type TransmitFifoEstR = crate::BitReader;
#[doc = "Field `TRANSMIT_FIFO_EST` writer - 2:2\\]
Transmit FIFO EST TimeStamp Enable"]
pub type TransmitFifoEstW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TRANSMIT_FIFO_EST` reader - 3:3\\]
Transmit FIFO EST TimeStamp First Express Packet"]
pub type TransmitFifoEstR = crate::BitReader;
#[doc = "Field `TRANSMIT_FIFO_EST` writer - 3:3\\]
Transmit FIFO EST TimeStamp First Express Packet"]
pub type TransmitFifoEstW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TRANSMIT_FIFO_EST` reader - 4:4\\]
Transmit FIFO EST TimeStamp One Priority"]
pub type TransmitFifoEstR = crate::BitReader;
#[doc = "Field `TRANSMIT_FIFO_EST` writer - 4:4\\]
Transmit FIFO EST TimeStamp One Priority"]
pub type TransmitFifoEstW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TRANSMIT_FIFO_EST` reader - 7:5\\]
Transmit FIFO EST TimeStamp Priority"]
pub type TransmitFifoEstR = crate::FieldReader;
#[doc = "Field `TRANSMIT_FIFO_EST` writer - 7:5\\]
Transmit FIFO EST TimeStamp Priority"]
pub type TransmitFifoEstW<'a, REG> = crate::FieldWriter<'a, REG, 3>;
#[doc = "Field `TRANSMIT_FIFO_EST` reader - 8:8\\]
Transmit FIFO EST Fill Enable"]
pub type TransmitFifoEstR = crate::BitReader;
#[doc = "Field `TRANSMIT_FIFO_EST` writer - 8:8\\]
Transmit FIFO EST Fill Enable"]
pub type TransmitFifoEstW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TRANSMIT_FIFO_EST` reader - 15:9\\]
Transmit FIFO EST Prempt Comparison Value to Clear wire"]
pub type TransmitFifoEstR = crate::FieldReader;
#[doc = "Field `TRANSMIT_FIFO_EST` writer - 15:9\\]
Transmit FIFO EST Prempt Comparison Value to Clear wire"]
pub type TransmitFifoEstW<'a, REG> = crate::FieldWriter<'a, REG, 7>;
...
Transmit FIFO EST One Buffer"]
    ...
    pub fn transmit_fifo_est(&self) -> TransmitFifoEstR {
        TransmitFifoEstR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Transmit FIFO EST Buffer Select"]
    #[inline(always)]
    pub fn transmit_fifo_est(&self) -> TransmitFifoEstR {
        TransmitFifoEstR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - 2:2\\]
Transmit FIFO EST TimeStamp Enable"]
    #[inline(always)]
    pub fn transmit_fifo_est(&self) -> TransmitFifoEstR {
        TransmitFifoEstR::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - 3:3\\]
Transmit FIFO EST TimeStamp First Express Packet"]
    #[inline(always)]
    pub fn transmit_fifo_est(&self) -> TransmitFifoEstR {
        TransmitFifoEstR::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - 4:4\\]
Transmit FIFO EST TimeStamp One Priority"]
    #[inline(always)]
    pub fn transmit_fifo_est(&self) -> TransmitFifoEstR {
        TransmitFifoEstR::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bits 5:7 - 7:5\\]
Transmit FIFO EST TimeStamp Priority"]
    #[inline(always)]
    pub fn transmit_fifo_est(&self) -> TransmitFifoEstR {
        TransmitFifoEstR::new(((self.bits >> 5) & 7) as u8)
    }
    #[doc = "Bit 8 - 8:8\\]
Transmit FIFO EST Fill Enable"]
    #[inline(always)]
    pub fn transmit_fifo_est(&self) -> TransmitFifoEstR {
        TransmitFifoEstR::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bits 9:15 - 15:9\\]
Transmit FIFO EST Prempt Comparison Value to Clear wire"]
    #[inline(always)]
    pub fn transmit_fifo_est(&self) -> TransmitFifoEstR {
        TransmitFifoEstR::new(((self.bits >> 9) & 0x7f) as u8)
    }
