#[doc = "Register `CPSW_NC_TX_G_BUF_THRESH_SET_L_REG` reader"]
pub type R = crate::R<CpswNcTxGBufThreshSetLRegSpec>;
#[doc = "Register `CPSW_NC_TX_G_BUF_THRESH_SET_L_REG` writer"]
pub type W = crate::W<CpswNcTxGBufThreshSetLRegSpec>;
...
Priority Based Flow Control Global Buffer Usage Threshold for Priority 0"]
    #[inline(always)]
    #[must_use]
    pub fn priority_based_flow_3(&mut self) -> PriorityBasedFlow3W<CpswNcTxGBufThreshSetLRegSpec> {
...
Priority Based Flow Control Global Buffer Usage Threshold for Priority 1"]
    #[inline(always)]
    #[must_use]
    pub fn priority_based_flow_2(&mut self) -> PriorityBasedFlow2W<CpswNcTxGBufThreshSetLRegSpec> {
...
Priority Based Flow Control Global Buffer Usage Threshold for Priority 2"]
    #[inline(always)]
    #[must_use]
    pub fn priority_based_flow_1(&mut self) -> PriorityBasedFlow1W<CpswNcTxGBufThreshSetLRegSpec> {
...
Priority Based Flow Control Global Buffer Usage Threshold for Priority 3"]
    #[inline(always)]
    #[must_use]
    pub fn priority_based_flow(&mut self) -> PriorityBasedFlowW<CpswNcTxGBufThreshSetLRegSpec> {
...
pub struct CpswNcTxGBufThreshSetLRegSpec;
impl crate::RegisterSpec for CpswNcTxGBufThreshSetLRegSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cpsw_nc_tx_g_buf_thresh_set_l_reg::R`](R) reader structure"]
impl crate::Readable for CpswNcTxGBufThreshSetLRegSpec {}
#[doc = "`write(|w| ..)` method takes [`cpsw_nc_tx_g_buf_thresh_set_l_reg::W`](W) writer structure"]
impl crate::Writable for CpswNcTxGBufThreshSetLRegSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CPSW_NC_TX_G_BUF_THRESH_SET_L_REG to value 0"]
impl crate::Resettable for CpswNcTxGBufThreshSetLRegSpec {
