#[doc = "Register `CPSW_NC_TX_G_BUF_THRESH_CLR_H_REG` reader"]
pub type R = crate::R<CpswNcTxGBufThreshClrHRegSpec>;
#[doc = "Register `CPSW_NC_TX_G_BUF_THRESH_CLR_H_REG` writer"]
pub type W = crate::W<CpswNcTxGBufThreshClrHRegSpec>;
...
Priority Based Flow Control Global Buffer Usage Threshold for Priority 4"]
    #[inline(always)]
    #[must_use]
    pub fn priority_based_flow_3(&mut self) -> PriorityBasedFlow3W<CpswNcTxGBufThreshClrHRegSpec> {
...
Priority Based Flow Control Global Buffer Usage Threshold for Priority 5"]
    #[inline(always)]
    #[must_use]
    pub fn priority_based_flow_2(&mut self) -> PriorityBasedFlow2W<CpswNcTxGBufThreshClrHRegSpec> {
...
Priority Based Flow Control Global Buffer Usage Threshold for Priority 6"]
    #[inline(always)]
    #[must_use]
    pub fn priority_based_flow_1(&mut self) -> PriorityBasedFlow1W<CpswNcTxGBufThreshClrHRegSpec> {
...
Priority Based Flow Control Global Buffer Usage Threshold for Priority 7"]
    #[inline(always)]
    #[must_use]
    pub fn priority_based_flow(&mut self) -> PriorityBasedFlowW<CpswNcTxGBufThreshClrHRegSpec> {
        PriorityBasedFlowW::new(self, 24)
    }
}
#[doc = "CPSW PFC Global Tx Buffer Threshold Clear High\n\nYou can [`read`](crate::Reg::read) this register and get [`cpsw_nc_tx_g_buf_thresh_clr_h_reg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cpsw_nc_tx_g_buf_thresh_clr_h_reg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CpswNcTxGBufThreshClrHRegSpec;
impl crate::RegisterSpec for CpswNcTxGBufThreshClrHRegSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cpsw_nc_tx_g_buf_thresh_clr_h_reg::R`](R) reader structure"]
impl crate::Readable for CpswNcTxGBufThreshClrHRegSpec {}
#[doc = "`write(|w| ..)` method takes [`cpsw_nc_tx_g_buf_thresh_clr_h_reg::W`](W) writer structure"]
impl crate::Writable for CpswNcTxGBufThreshClrHRegSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CPSW_NC_TX_G_BUF_THRESH_CLR_H_REG to value 0"]
impl crate::Resettable for CpswNcTxGBufThreshClrHRegSpec {
