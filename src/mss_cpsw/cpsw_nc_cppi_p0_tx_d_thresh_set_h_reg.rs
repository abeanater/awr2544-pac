#[doc = "Register `CPSW_NC_CPPI_P0_TX_D_THRESH_SET_H_REG` reader"]
...
#[doc = "CPPI Port 0 Tx PFC Destination Threshold Set High\n\nYou can [`read`](crate::Reg::read) this register and get [`cpsw_nc_cppi_p0_tx_d_thresh_set_h_reg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cpsw_nc_cppi_p0_tx_d_thresh_set_h_reg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CpswNcCppiP0TxDThreshSetHRegSpec;
impl crate::RegisterSpec for CpswNcCppiP0TxDThreshSetHRegSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cpsw_nc_cppi_p0_tx_d_thresh_set_h_reg::R`](R) reader structure"]
impl crate::Readable for CpswNcCppiP0TxDThreshSetHRegSpec {}
#[doc = "`write(|w| ..)` method takes [`cpsw_nc_cppi_p0_tx_d_thresh_set_h_reg::W`](W) writer structure"]
impl crate::Writable for CpswNcCppiP0TxDThreshSetHRegSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CPSW_NC_CPPI_P0_TX_D_THRESH_SET_H_REG to value 0"]
impl crate::Resettable for CpswNcCppiP0TxDThreshSetHRegSpec {
