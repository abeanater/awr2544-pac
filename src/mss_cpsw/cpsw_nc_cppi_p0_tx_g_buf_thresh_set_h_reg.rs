#[doc = "Register `CPSW_NC_CPPI_P0_TX_G_BUF_THRESH_SET_H_REG` reader"]
pub type R = crate::R<CpswNcCppiP0TxGBufThreshSetHRegSpec>;
#[doc = "Register `CPSW_NC_CPPI_P0_TX_G_BUF_THRESH_SET_H_REG` writer"]
pub type W = crate::W<CpswNcCppiP0TxGBufThreshSetHRegSpec>;
...
Port Priority Based Flow Control Threshold Set Value for Priority 4"]
    ...
    pub fn port_priority_based_3(
        &mut self,
    ) -> PortPriorityBased3W<CpswNcCppiP0TxGBufThreshSetHRegSpec> {
...
Port Priority Based Flow Control Threshold Set Value for Priority 5"]
    ...
    pub fn port_priority_based_2(
        &mut self,
    ) -> PortPriorityBased2W<CpswNcCppiP0TxGBufThreshSetHRegSpec> {
...
Port Priority Based Flow Control Threshold Set Value for Priority 6"]
    ...
    pub fn port_priority_based_1(
        &mut self,
    ) -> PortPriorityBased1W<CpswNcCppiP0TxGBufThreshSetHRegSpec> {
...
Port Priority Based Flow Control Threshold Set Value for Priority 7"]
    ...
    pub fn port_priority_based(
        &mut self,
    ) -> PortPriorityBasedW<CpswNcCppiP0TxGBufThreshSetHRegSpec> {
        PortPriorityBasedW::new(self, 24)
    }
}
#[doc = "CPPI Port 0 Tx PFC Global Buffer Threshold Set High\n\nYou can [`read`](crate::Reg::read) this register and get [`cpsw_nc_cppi_p0_tx_g_buf_thresh_set_h_reg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cpsw_nc_cppi_p0_tx_g_buf_thresh_set_h_reg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CpswNcCppiP0TxGBufThreshSetHRegSpec;
impl crate::RegisterSpec for CpswNcCppiP0TxGBufThreshSetHRegSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cpsw_nc_cppi_p0_tx_g_buf_thresh_set_h_reg::R`](R) reader structure"]
impl crate::Readable for CpswNcCppiP0TxGBufThreshSetHRegSpec {}
#[doc = "`write(|w| ..)` method takes [`cpsw_nc_cppi_p0_tx_g_buf_thresh_set_h_reg::W`](W) writer structure"]
impl crate::Writable for CpswNcCppiP0TxGBufThreshSetHRegSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CPSW_NC_CPPI_P0_TX_G_BUF_THRESH_SET_H_REG to value 0"]
impl crate::Resettable for CpswNcCppiP0TxGBufThreshSetHRegSpec {
