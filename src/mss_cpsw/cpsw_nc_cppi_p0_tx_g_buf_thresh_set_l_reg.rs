#[doc = "Register `CPSW_NC_CPPI_P0_TX_G_BUF_THRESH_SET_L_REG` reader"]
pub type R = crate::R<CpswNcCppiP0TxGBufThreshSetLRegSpec>;
#[doc = "Register `CPSW_NC_CPPI_P0_TX_G_BUF_THRESH_SET_L_REG` writer"]
pub type W = crate::W<CpswNcCppiP0TxGBufThreshSetLRegSpec>;
...
Port Priority Based Flow Control Threshold Set Value for Priority 0"]
    ...
    pub fn port_priority_based_3(
        &mut self,
    ) -> PortPriorityBased3W<CpswNcCppiP0TxGBufThreshSetLRegSpec> {
...
Port Priority Based Flow Control Threshold Set Value for Priority 1"]
    ...
    pub fn port_priority_based_2(
        &mut self,
    ) -> PortPriorityBased2W<CpswNcCppiP0TxGBufThreshSetLRegSpec> {
...
Port Priority Based Flow Control Threshold Set Value for Priority 2"]
    ...
    pub fn port_priority_based_1(
        &mut self,
    ) -> PortPriorityBased1W<CpswNcCppiP0TxGBufThreshSetLRegSpec> {
...
Port Priority Based Flow Control Threshold Set Value for Priority 3"]
    ...
    pub fn port_priority_based(
        &mut self,
    ) -> PortPriorityBasedW<CpswNcCppiP0TxGBufThreshSetLRegSpec> {
        PortPriorityBasedW::new(self, 24)
    }
}
#[doc = "CPPI Port 0 Tx PFC Global Buffer Threshold Set Low\n\nYou can [`read`](crate::Reg::read) this register and get [`cpsw_nc_cppi_p0_tx_g_buf_thresh_set_l_reg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cpsw_nc_cppi_p0_tx_g_buf_thresh_set_l_reg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CpswNcCppiP0TxGBufThreshSetLRegSpec;
impl crate::RegisterSpec for CpswNcCppiP0TxGBufThreshSetLRegSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cpsw_nc_cppi_p0_tx_g_buf_thresh_set_l_reg::R`](R) reader structure"]
impl crate::Readable for CpswNcCppiP0TxGBufThreshSetLRegSpec {}
#[doc = "`write(|w| ..)` method takes [`cpsw_nc_cppi_p0_tx_g_buf_thresh_set_l_reg::W`](W) writer structure"]
impl crate::Writable for CpswNcCppiP0TxGBufThreshSetLRegSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CPSW_NC_CPPI_P0_TX_G_BUF_THRESH_SET_L_REG to value 0"]
impl crate::Resettable for CpswNcCppiP0TxGBufThreshSetLRegSpec {
