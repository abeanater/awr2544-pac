#[doc = "Register `CPSW_NC_CPPI_P0_TX_D_THRESH_CLR_L_REG` reader"]
pub type R = crate::R<CpswNcCppiP0TxDThreshClrLRegSpec>;
#[doc = "Register `CPSW_NC_CPPI_P0_TX_D_THRESH_CLR_L_REG` writer"]
pub type W = crate::W<CpswNcCppiP0TxDThreshClrLRegSpec>;
...
Port Priority Based Flow Control Threshold Clear Value for Priority 0"]
    ...
    pub fn port_priority_based_3(
        &mut self,
    ) -> PortPriorityBased3W<CpswNcCppiP0TxDThreshClrLRegSpec> {
...
Port Priority Based Flow Control Threshold Clear Value for Priority 1"]
    ...
    pub fn port_priority_based_2(
        &mut self,
    ) -> PortPriorityBased2W<CpswNcCppiP0TxDThreshClrLRegSpec> {
...
Port Priority Based Flow Control Threshold Clear Value for Priority 2"]
    ...
    pub fn port_priority_based_1(
        &mut self,
    ) -> PortPriorityBased1W<CpswNcCppiP0TxDThreshClrLRegSpec> {
...
Port Priority Based Flow Control Threshold Clear Value for Priority 3"]
    #[inline(always)]
    #[must_use]
    pub fn port_priority_based(&mut self) -> PortPriorityBasedW<CpswNcCppiP0TxDThreshClrLRegSpec> {
        PortPriorityBasedW::new(self, 24)
    }
}
#[doc = "CPPI Port 0 Tx PFC Destination Threshold Clr Low\n\nYou can [`read`](crate::Reg::read) this register and get [`cpsw_nc_cppi_p0_tx_d_thresh_clr_l_reg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cpsw_nc_cppi_p0_tx_d_thresh_clr_l_reg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CpswNcCppiP0TxDThreshClrLRegSpec;
impl crate::RegisterSpec for CpswNcCppiP0TxDThreshClrLRegSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cpsw_nc_cppi_p0_tx_d_thresh_clr_l_reg::R`](R) reader structure"]
impl crate::Readable for CpswNcCppiP0TxDThreshClrLRegSpec {}
#[doc = "`write(|w| ..)` method takes [`cpsw_nc_cppi_p0_tx_d_thresh_clr_l_reg::W`](W) writer structure"]
impl crate::Writable for CpswNcCppiP0TxDThreshClrLRegSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CPSW_NC_CPPI_P0_TX_D_THRESH_CLR_L_REG to value 0"]
impl crate::Resettable for CpswNcCppiP0TxDThreshClrLRegSpec {
