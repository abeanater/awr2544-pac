#[doc = "Register `USER_GROUP1_USER_ACCESS_REG` reader"]
pub type R = crate::R<UserGroup1UserAccessRegSpec>;
#[doc = "Register `USER_GROUP1_USER_ACCESS_REG` writer"]
pub type W = crate::W<UserGroup1UserAccessRegSpec>;
...
User data"]
    #[inline(always)]
    #[must_use]
    pub fn user_data(&mut self) -> UserDataW<UserGroup1UserAccessRegSpec> {
...
PHY address"]
    #[inline(always)]
    #[must_use]
    pub fn phy_address(&mut self) -> PhyAddressW<UserGroup1UserAccessRegSpec> {
...
Register address"]
    #[inline(always)]
    #[must_use]
    pub fn register_address(&mut self) -> RegisterAddressW<UserGroup1UserAccessRegSpec> {
...
Acknowledge"]
    #[inline(always)]
    #[must_use]
    pub fn acknowledge(&mut self) -> AcknowledgeW<UserGroup1UserAccessRegSpec> {
...
Write"]
    #[inline(always)]
    #[must_use]
    pub fn write(&mut self) -> WriteW<UserGroup1UserAccessRegSpec> {
        WriteW::new(self, 30)
    }
    #[doc = "Bit 31 - 31:31\\]
Go"]
    #[inline(always)]
    #[must_use]
    pub fn go(&mut self) -> GoW<UserGroup1UserAccessRegSpec> {
        GoW::new(self, 31)
    }
}
#[doc = "MDIO User Access Register\n\nYou can [`read`](crate::Reg::read) this register and get [`user_group1_user_access_reg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`user_group1_user_access_reg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct UserGroup1UserAccessRegSpec;
impl crate::RegisterSpec for UserGroup1UserAccessRegSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`user_group1_user_access_reg::R`](R) reader structure"]
impl crate::Readable for UserGroup1UserAccessRegSpec {}
#[doc = "`write(|w| ..)` method takes [`user_group1_user_access_reg::W`](W) writer structure"]
impl crate::Writable for UserGroup1UserAccessRegSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets USER_GROUP1_USER_ACCESS_REG to value 0"]
impl crate::Resettable for UserGroup1UserAccessRegSpec {
