...
A DSCP IPV4/V6 packet TOS of N*8+0 is mapped to this received priority"]
    #[inline(always)]
    #[must_use]
    pub fn a_dscp_ipv4_v6_7(&mut self) -> ADscpIpv4V6_7W<CpswNcCppiP0RxDscpMapReg6Spec> {
...
A DSCP IPV4/V6 packet TOS of N*8+1 is mapped to this received priority"]
    #[inline(always)]
    #[must_use]
    pub fn a_dscp_ipv4_v6_6(&mut self) -> ADscpIpv4V6_6W<CpswNcCppiP0RxDscpMapReg6Spec> {
...
A DSCP IPV4/V6 packet TOS of N*8+2 is mapped to this received priority"]
    #[inline(always)]
    #[must_use]
    pub fn a_dscp_ipv4_v6_5(&mut self) -> ADscpIpv4V6_5W<CpswNcCppiP0RxDscpMapReg6Spec> {
...
A DSCP IPV4/V6 packet TOS of N*8+3 is mapped to this received priority"]
    #[inline(always)]
    #[must_use]
    pub fn a_dscp_ipv4_v6_4(&mut self) -> ADscpIpv4V6_4W<CpswNcCppiP0RxDscpMapReg6Spec> {
...
A DSCP IPV4/V6 packet TOS of N*8+4 is mapped to this received priority"]
    #[inline(always)]
    #[must_use]
    pub fn a_dscp_ipv4_v6_3(&mut self) -> ADscpIpv4V6_3W<CpswNcCppiP0RxDscpMapReg6Spec> {
...
A DSCP IPV4/V6 packet TOS of N*8+5 is mapped to this received priority"]
    #[inline(always)]
    #[must_use]
    pub fn a_dscp_ipv4_v6_2(&mut self) -> ADscpIpv4V6_2W<CpswNcCppiP0RxDscpMapReg6Spec> {
...
A DSCP IPV4/V6 packet TOS of N*8+6 is mapped to this received priority"]
    #[inline(always)]
    #[must_use]
    pub fn a_dscp_ipv4_v6_1(&mut self) -> ADscpIpv4V6_1W<CpswNcCppiP0RxDscpMapReg6Spec> {
