#[doc = "Register `USER_GROUP1_USER_PHY_SEL_REG` reader"]
pub type R = crate::R<UserGroup1UserPhySelRegSpec>;
#[doc = "Register `USER_GROUP1_USER_PHY_SEL_REG` writer"]
pub type W = crate::W<UserGroup1UserPhySelRegSpec>;
...
PHY address whose link status is monitored"]
    #[inline(always)]
    #[must_use]
    pub fn phy_address_whose(&mut self) -> PhyAddressWhoseW<UserGroup1UserPhySelRegSpec> {
...
Link change interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn link_change_interrupt(&mut self) -> LinkChangeInterruptW<UserGroup1UserPhySelRegSpec> {
...
Link status determination select"]
    ...
    pub fn link_status_determination(
        &mut self,
    ) -> LinkStatusDeterminationW<UserGroup1UserPhySelRegSpec> {
        LinkStatusDeterminationW::new(self, 7)
    }
}
#[doc = "MDIO User PHY Select Register\n\nYou can [`read`](crate::Reg::read) this register and get [`user_group1_user_phy_sel_reg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`user_group1_user_phy_sel_reg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct UserGroup1UserPhySelRegSpec;
impl crate::RegisterSpec for UserGroup1UserPhySelRegSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`user_group1_user_phy_sel_reg::R`](R) reader structure"]
impl crate::Readable for UserGroup1UserPhySelRegSpec {}
#[doc = "`write(|w| ..)` method takes [`user_group1_user_phy_sel_reg::W`](W) writer structure"]
impl crate::Writable for UserGroup1UserPhySelRegSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets USER_GROUP1_USER_PHY_SEL_REG to value 0"]
impl crate::Resettable for UserGroup1UserPhySelRegSpec {
