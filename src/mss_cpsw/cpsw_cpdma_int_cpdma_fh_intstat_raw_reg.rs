...
CPDMA FHost Channel 0 Interrupt Pending RAW"]
    ...
    pub fn cpdma_fhost_channel_7(
        &mut self,
    ) -> CpdmaFhostChannel7W<CpswCpdmaIntCpdmaFhIntstatRawRegSpec> {
...
CPDMA FHost Channel 1 Interrupt Pending RAW"]
    ...
    pub fn cpdma_fhost_channel_6(
        &mut self,
    ) -> CpdmaFhostChannel6W<CpswCpdmaIntCpdmaFhIntstatRawRegSpec> {
...
CPDMA FHost Channel 2 Interrupt Pending RAW"]
    ...
    pub fn cpdma_fhost_channel_5(
        &mut self,
    ) -> CpdmaFhostChannel5W<CpswCpdmaIntCpdmaFhIntstatRawRegSpec> {
...
CPDMA FHost Channel 3 Interrupt Pending RAW"]
    ...
    pub fn cpdma_fhost_channel_4(
        &mut self,
    ) -> CpdmaFhostChannel4W<CpswCpdmaIntCpdmaFhIntstatRawRegSpec> {
...
CPDMA FHost Channel 4 Interrupt Pending RAW"]
    ...
    pub fn cpdma_fhost_channel_3(
        &mut self,
    ) -> CpdmaFhostChannel3W<CpswCpdmaIntCpdmaFhIntstatRawRegSpec> {
...
CPDMA FHost Channel 5 Interrupt Pending RAW"]
    ...
    pub fn cpdma_fhost_channel_2(
        &mut self,
    ) -> CpdmaFhostChannel2W<CpswCpdmaIntCpdmaFhIntstatRawRegSpec> {
...
CPDMA FHost Channel 6 Interrupt Pending RAW"]
    ...
    pub fn cpdma_fhost_channel_1(
        &mut self,
    ) -> CpdmaFhostChannel1W<CpswCpdmaIntCpdmaFhIntstatRawRegSpec> {
