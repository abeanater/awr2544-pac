...
Core 0 MISC MDIO linkint - OR of bits 1 and 0"]
    #[inline(always)]
    #[must_use]
    pub fn core_0_misc_5(&mut self) -> Core0Misc5W<RegsIntSsC0MiscStatusRegSpec> {
...
Core 0 MISC Host Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn core_0_misc_4(&mut self) -> Core0Misc4W<RegsIntSsC0MiscStatusRegSpec> {
...
Core 0 MISC Statistics Interrupt - OR of bits n downto 0"]
    #[inline(always)]
    #[must_use]
    pub fn core_0_misc_3(&mut self) -> Core0Misc3W<RegsIntSsC0MiscStatusRegSpec> {
...
Core 0 MISC CPTS Event Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn core_0_misc_2(&mut self) -> Core0Misc2W<RegsIntSsC0MiscStatusRegSpec> {
...
Core 0 MISC SEC Memory Protect Error Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn core_0_misc_1(&mut self) -> Core0Misc1W<RegsIntSsC0MiscStatusRegSpec> {
