#[doc = "Register `CPSW_NC_ETH_MAC_0_PN_TX_PRI_MAP_REG` reader"]
pub type R = crate::R<CpswNcEthMac0PnTxPriMapRegSpec>;
#[doc = "Register `CPSW_NC_ETH_MAC_0_PN_TX_PRI_MAP_REG` writer"]
pub type W = crate::W<CpswNcEthMac0PnTxPriMapRegSpec>;
...
Priority 0"]
    #[inline(always)]
    #[must_use]
    pub fn priority_0(&mut self) -> Priority0W<CpswNcEthMac0PnTxPriMapRegSpec> {
...
Priority 1"]
    #[inline(always)]
    #[must_use]
    pub fn priority_1(&mut self) -> Priority1W<CpswNcEthMac0PnTxPriMapRegSpec> {
...
Priority 2"]
    #[inline(always)]
    #[must_use]
    pub fn priority_2(&mut self) -> Priority2W<CpswNcEthMac0PnTxPriMapRegSpec> {
...
Priority 3"]
    #[inline(always)]
    #[must_use]
    pub fn priority_3(&mut self) -> Priority3W<CpswNcEthMac0PnTxPriMapRegSpec> {
...
Priority 4"]
    #[inline(always)]
    #[must_use]
    pub fn priority_4(&mut self) -> Priority4W<CpswNcEthMac0PnTxPriMapRegSpec> {
...
Priority 5"]
    #[inline(always)]
    #[must_use]
    pub fn priority_5(&mut self) -> Priority5W<CpswNcEthMac0PnTxPriMapRegSpec> {
...
Priority 6"]
    #[inline(always)]
    #[must_use]
    pub fn priority_6(&mut self) -> Priority6W<CpswNcEthMac0PnTxPriMapRegSpec> {
...
Priority 7"]
    #[inline(always)]
    #[must_use]
    pub fn priority_7(&mut self) -> Priority7W<CpswNcEthMac0PnTxPriMapRegSpec> {
        Priority7W::new(self, 28)
    }
}
#[doc = "Enet Port N Tx Header Pri to Switch Pri Mapping\n\nYou can [`read`](crate::Reg::read) this register and get [`cpsw_nc_eth_mac_0_pn_tx_pri_map_reg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cpsw_nc_eth_mac_0_pn_tx_pri_map_reg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CpswNcEthMac0PnTxPriMapRegSpec;
impl crate::RegisterSpec for CpswNcEthMac0PnTxPriMapRegSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cpsw_nc_eth_mac_0_pn_tx_pri_map_reg::R`](R) reader structure"]
impl crate::Readable for CpswNcEthMac0PnTxPriMapRegSpec {}
#[doc = "`write(|w| ..)` method takes [`cpsw_nc_eth_mac_0_pn_tx_pri_map_reg::W`](W) writer structure"]
impl crate::Writable for CpswNcEthMac0PnTxPriMapRegSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CPSW_NC_ETH_MAC_0_PN_TX_PRI_MAP_REG to value 0"]
impl crate::Resettable for CpswNcEthMac0PnTxPriMapRegSpec {
