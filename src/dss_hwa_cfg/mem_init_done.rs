#[doc = "Register `MEM_INIT_DONE` reader"]
pub type R = crate::R<MemInitDoneSpec>;
#[doc = "Register `MEM_INIT_DONE` writer"]
pub type W = crate::W<MemInitDoneSpec>;
#[doc = "Field `dmem0` reader - 0:0\\]
Will be 1'b1 after cmpletion of memory initialization for dmem0"]
...
Will be 1'b1 after cmpletion of memory initialization for dmem1"]
...
Will be 1'b1 after cmpletion of memory initialization for dmem2"]
...
Will be 1'b1 after cmpletion of memory initialization for dmem3"]
...
Will be 1'b1 after cmpletion of memory initialization for param_ram"]
...
Will be 1'b1 after cmpletion of memory initialization for window_ram"]
...
Will be 1'b1 after cmpletion of memory initialization for dmem0"]
    #[inline(always)]
    #[must_use]
    pub fn dmem0(&mut self) -> Dmem0W<MemInitDoneSpec> {
        Dmem0W::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Will be 1'b1 after cmpletion of memory initialization for dmem1"]
    #[inline(always)]
    #[must_use]
    pub fn dmem1(&mut self) -> Dmem1W<MemInitDoneSpec> {
        Dmem1W::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
Will be 1'b1 after cmpletion of memory initialization for dmem2"]
    #[inline(always)]
    #[must_use]
    pub fn dmem2(&mut self) -> Dmem2W<MemInitDoneSpec> {
        Dmem2W::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
Will be 1'b1 after cmpletion of memory initialization for dmem3"]
    #[inline(always)]
    #[must_use]
    pub fn dmem3(&mut self) -> Dmem3W<MemInitDoneSpec> {
        Dmem3W::new(self, 3)
    }
    #[doc = "Bit 8 - 8:8\\]
Will be 1'b1 after cmpletion of memory initialization for param_ram"]
    #[inline(always)]
    #[must_use]
    pub fn param_ram(&mut self) -> ParamRamW<MemInitDoneSpec> {
...
Will be 1'b1 after cmpletion of memory initialization for window_ram"]
    #[inline(always)]
    #[must_use]
    pub fn window_ram(&mut self) -> WindowRamW<MemInitDoneSpec> {
        WindowRamW::new(self, 9)
    }
}
#[doc = "MEM_INIT_DONE\n\nYou can [`read`](crate::Reg::read) this register and get [`mem_init_done::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mem_init_done::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MemInitDoneSpec;
impl crate::RegisterSpec for MemInitDoneSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mem_init_done::R`](R) reader structure"]
impl crate::Readable for MemInitDoneSpec {}
#[doc = "`write(|w| ..)` method takes [`mem_init_done::W`](W) writer structure"]
impl crate::Writable for MemInitDoneSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MEM_INIT_DONE to value 0"]
