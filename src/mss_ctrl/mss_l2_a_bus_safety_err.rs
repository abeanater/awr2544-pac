#[doc = "Register `MSS_L2_A_BUS_SAFETY_ERR` reader"]
pub type R = crate::R<MssL2ABusSafetyErrSpec>;
#[doc = "Register `MSS_L2_A_BUS_SAFETY_ERR` writer"]
pub type W = crate::W<MssL2ABusSafetyErrSpec>;
...
Refer to TPR12 Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn comp_err(&mut self) -> CompErrW<MssL2ABusSafetyErrSpec> {
        CompErrW::new(self, 0)
    }
    #[doc = "Bits 8:15 - 15:8\\]
Refer to TPR12 Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn comp_check(&mut self) -> CompCheckW<MssL2ABusSafetyErrSpec> {
...
Refer to TPR12 Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn sec(&mut self) -> SecW<MssL2ABusSafetyErrSpec> {
        SecW::new(self, 16)
    }
    #[doc = "Bits 24:31 - 31:24\\]
Refer to TPR12 Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn ded(&mut self) -> DedW<MssL2ABusSafetyErrSpec> {
        DedW::new(self, 24)
    }
}
#[doc = "MSS_L2_A_BUS_SAFETY_ERR\n\nYou can [`read`](crate::Reg::read) this register and get [`mss_l2_a_bus_safety_err::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mss_l2_a_bus_safety_err::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MssL2ABusSafetyErrSpec;
impl crate::RegisterSpec for MssL2ABusSafetyErrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mss_l2_a_bus_safety_err::R`](R) reader structure"]
impl crate::Readable for MssL2ABusSafetyErrSpec {}
#[doc = "`write(|w| ..)` method takes [`mss_l2_a_bus_safety_err::W`](W) writer structure"]
impl crate::Writable for MssL2ABusSafetyErrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MSS_L2_A_BUS_SAFETY_ERR to value 0"]
impl crate::Resettable for MssL2ABusSafetyErrSpec {
