#[doc = "Register `MSS_CR5A_AXI_RD_BUS_SAFETY_FI` reader"]
pub type R = crate::R<MssCr5aAxiRdBusSafetyFiSpec>;
#[doc = "Register `MSS_CR5A_AXI_RD_BUS_SAFETY_FI` writer"]
pub type W = crate::W<MssCr5aAxiRdBusSafetyFiSpec>;
...
Refer to TPR12 Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn global_main(&mut self) -> GlobalMainW<MssCr5aAxiRdBusSafetyFiSpec> {
...
Refer to TPR12 Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn global_safe(&mut self) -> GlobalSafeW<MssCr5aAxiRdBusSafetyFiSpec> {
...
Refer to TPR12 Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn global_main_req(&mut self) -> GlobalMainReqW<MssCr5aAxiRdBusSafetyFiSpec> {
...
Refer to TPR12 Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn global_safe_req(&mut self) -> GlobalSafeReqW<MssCr5aAxiRdBusSafetyFiSpec> {
...
Refer to TPR12 Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn sec(&mut self) -> SecW<MssCr5aAxiRdBusSafetyFiSpec> {
        SecW::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
Refer to TPR12 Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn ded(&mut self) -> DedW<MssCr5aAxiRdBusSafetyFiSpec> {
        DedW::new(self, 5)
    }
    #[doc = "Bits 8:15 - 15:8\\]
Refer to TPR12 Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn data(&mut self) -> DataW<MssCr5aAxiRdBusSafetyFiSpec> {
        DataW::new(self, 8)
    }
    #[doc = "Bits 16:23 - 23:16\\]
Refer to TPR12 Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn main(&mut self) -> MainW<MssCr5aAxiRdBusSafetyFiSpec> {
        MainW::new(self, 16)
    }
    #[doc = "Bits 24:31 - 31:24\\]
Refer to TPR12 Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn safe(&mut self) -> SafeW<MssCr5aAxiRdBusSafetyFiSpec> {
        SafeW::new(self, 24)
    }
}
#[doc = "MSS_CR5A_AXI_RD_BUS_SAFETY_FI\n\nYou can [`read`](crate::Reg::read) this register and get [`mss_cr5a_axi_rd_bus_safety_fi::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mss_cr5a_axi_rd_bus_safety_fi::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MssCr5aAxiRdBusSafetyFiSpec;
impl crate::RegisterSpec for MssCr5aAxiRdBusSafetyFiSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mss_cr5a_axi_rd_bus_safety_fi::R`](R) reader structure"]
impl crate::Readable for MssCr5aAxiRdBusSafetyFiSpec {}
#[doc = "`write(|w| ..)` method takes [`mss_cr5a_axi_rd_bus_safety_fi::W`](W) writer structure"]
impl crate::Writable for MssCr5aAxiRdBusSafetyFiSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MSS_CR5A_AXI_RD_BUS_SAFETY_FI to value 0"]
impl crate::Resettable for MssCr5aAxiRdBusSafetyFiSpec {
