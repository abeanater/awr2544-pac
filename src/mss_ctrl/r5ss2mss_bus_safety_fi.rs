#[doc = "Register `R5SS2MSS_BUS_SAFETY_FI` reader"]
pub type R = crate::R<R5ss2mssBusSafetyFiSpec>;
#[doc = "Register `R5SS2MSS_BUS_SAFETY_FI` writer"]
pub type W = crate::W<R5ss2mssBusSafetyFiSpec>;
...
Refer to 25xx Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn global_main(&mut self) -> GlobalMainW<R5ss2mssBusSafetyFiSpec> {
...
Refer to 25xx Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn global_safe(&mut self) -> GlobalSafeW<R5ss2mssBusSafetyFiSpec> {
...
Refer to 25xx Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn global_main_req(&mut self) -> GlobalMainReqW<R5ss2mssBusSafetyFiSpec> {
...
Refer to 25xx Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn global_safe_req(&mut self) -> GlobalSafeReqW<R5ss2mssBusSafetyFiSpec> {
...
Refer to 25xx Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn sec(&mut self) -> SecW<R5ss2mssBusSafetyFiSpec> {
        SecW::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
Refer to 25xx Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn ded(&mut self) -> DedW<R5ss2mssBusSafetyFiSpec> {
        DedW::new(self, 5)
    }
    #[doc = "Bits 8:15 - 15:8\\]
Refer to 25xx Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn data(&mut self) -> DataW<R5ss2mssBusSafetyFiSpec> {
        DataW::new(self, 8)
    }
    #[doc = "Bits 16:23 - 23:16\\]
Refer to 25xx Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn main(&mut self) -> MainW<R5ss2mssBusSafetyFiSpec> {
        MainW::new(self, 16)
    }
    #[doc = "Bits 24:31 - 31:24\\]
Refer to 25xx Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn safe(&mut self) -> SafeW<R5ss2mssBusSafetyFiSpec> {
        SafeW::new(self, 24)
    }
}
#[doc = "R5SS2MSS_BUS_SAFETY_FI\n\nYou can [`read`](crate::Reg::read) this register and get [`r5ss2mss_bus_safety_fi::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`r5ss2mss_bus_safety_fi::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct R5ss2mssBusSafetyFiSpec;
impl crate::RegisterSpec for R5ss2mssBusSafetyFiSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`r5ss2mss_bus_safety_fi::R`](R) reader structure"]
impl crate::Readable for R5ss2mssBusSafetyFiSpec {}
#[doc = "`write(|w| ..)` method takes [`r5ss2mss_bus_safety_fi::W`](W) writer structure"]
impl crate::Writable for R5ss2mssBusSafetyFiSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets R5SS2MSS_BUS_SAFETY_FI to value 0"]
impl crate::Resettable for R5ss2mssBusSafetyFiSpec {
