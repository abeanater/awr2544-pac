#[doc = "Register `R5SS2MSS_BUS_SAFETY_ERR` reader"]
pub type R = crate::R<R5ss2mssBusSafetyErrSpec>;
#[doc = "Register `R5SS2MSS_BUS_SAFETY_ERR` writer"]
pub type W = crate::W<R5ss2mssBusSafetyErrSpec>;
...
Refer to 25xx Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn comp_err(&mut self) -> CompErrW<R5ss2mssBusSafetyErrSpec> {
        CompErrW::new(self, 0)
    }
    #[doc = "Bits 8:15 - 15:8\\]
Refer to 25xx Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn comp_check(&mut self) -> CompCheckW<R5ss2mssBusSafetyErrSpec> {
...
Refer to 25xx Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn sec(&mut self) -> SecW<R5ss2mssBusSafetyErrSpec> {
        SecW::new(self, 16)
    }
    #[doc = "Bits 24:31 - 31:24\\]
Refer to 25xx Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn ded(&mut self) -> DedW<R5ss2mssBusSafetyErrSpec> {
        DedW::new(self, 24)
    }
}
#[doc = "R5SS2MSS_BUS_SAFETY_ERR\n\nYou can [`read`](crate::Reg::read) this register and get [`r5ss2mss_bus_safety_err::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`r5ss2mss_bus_safety_err::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct R5ss2mssBusSafetyErrSpec;
impl crate::RegisterSpec for R5ss2mssBusSafetyErrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`r5ss2mss_bus_safety_err::R`](R) reader structure"]
impl crate::Readable for R5ss2mssBusSafetyErrSpec {}
#[doc = "`write(|w| ..)` method takes [`r5ss2mss_bus_safety_err::W`](W) writer structure"]
impl crate::Writable for R5ss2mssBusSafetyErrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets R5SS2MSS_BUS_SAFETY_ERR to value 0"]
impl crate::Resettable for R5ss2mssBusSafetyErrSpec {
