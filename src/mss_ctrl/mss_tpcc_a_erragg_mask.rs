#[doc = "Register `MSS_TPCC_A_ERRAGG_MASK` reader"]
pub type R = crate::R<MssTpccAErraggMaskSpec>;
#[doc = "Register `MSS_TPCC_A_ERRAGG_MASK` writer"]
pub type W = crate::W<MssTpccAErraggMaskSpec>;
#[doc = "Field `tpcc_a_errint` reader - 0:0\\]
Mask Error from MSS_TPCC_A to aggregated Error MSS_TPCC_A_ERRAGG 1 : Error is Masked 0 : Error is Unmasked"]
...
Mask Error from MSS_TPTC_A0 to aggregated Error MSS_TPCC_A_ERRAGG 1 : Error is Masked 0 : Error is Unmasked"]
...
Mask Error from MSS_TPTC_A1 to aggregated Error MSS_TPCC_A_ERRAGG 1 : Error is Masked 0 : Error is Unmasked"]
...
Mask Error from MSS_TPCC_A to aggregated Error MSS_TPCC_A_ERRAGG 1 : Error is Masked 0 : Error is Unmasked"]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_errint(&mut self) -> TpccAErrintW<MssTpccAErraggMaskSpec> {
...
Mask Error from MSS_TPCC_A to aggregated Error MSS_TPCC_A_ERRAGG 1 : Error is Masked 0 : Error is Unmasked"]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_mpint(&mut self) -> TpccAMpintW<MssTpccAErraggMaskSpec> {
...
Mask Error from MSS_TPTC_A0 to aggregated Error MSS_TPCC_A_ERRAGG 1 : Error is Masked 0 : Error is Unmasked"]
    #[inline(always)]
    #[must_use]
    pub fn tptc_a0_err(&mut self) -> TptcA0ErrW<MssTpccAErraggMaskSpec> {
...
Mask Error from MSS_TPTC_A1 to aggregated Error MSS_TPCC_A_ERRAGG 1 : Error is Masked 0 : Error is Unmasked"]
    #[inline(always)]
    #[must_use]
    pub fn tptc_a1_err(&mut self) -> TptcA1ErrW<MssTpccAErraggMaskSpec> {
...
Mask Error from MSS_TPCC_A to aggregated Error MSS_TPCC_A_ERRAGG 1 : Error is Masked 0 : Error is Unmasked"]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_par_err(&mut self) -> TpccAParErrW<MssTpccAErraggMaskSpec> {
...
Mask Error from MSS_TPCC_A to aggregated Error MSS_TPCC_A_ERRAGG 1 : Error is Masked 0 : Error is Unmasked"]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_write_access_error(&mut self) -> TpccAWriteAccessErrorW<MssTpccAErraggMaskSpec> {
...
Mask Error from MSS_TPTC_A0 to aggregated Error MSS_TPCC_A_ERRAGG 1 : Error is Masked 0 : Error is Unmasked"]
    ...
    pub fn tptc_a0_write_access_error(
        &mut self,
    ) -> TptcA0WriteAccessErrorW<MssTpccAErraggMaskSpec> {
...
Mask Error from MSS_TPTC_A1 to aggregated Error MSS_TPCC_A_ERRAGG 1 : Error is Masked 0 : Error is Unmasked"]
    ...
    pub fn tptc_a1_write_access_error(
        &mut self,
    ) -> TptcA1WriteAccessErrorW<MssTpccAErraggMaskSpec> {
...
Mask Error from MSS_TPCC_A to aggregated Error MSS_TPCC_A_ERRAGG 1 : Error is Masked 0 : Error is Unmasked"]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_read_access_error(&mut self) -> TpccAReadAccessErrorW<MssTpccAErraggMaskSpec> {
...
Mask Error from MSS_TPTC_A0 to aggregated Error MSS_TPCC_A_ERRAGG 1 : Error is Masked 0 : Error is Unmasked"]
    #[inline(always)]
    #[must_use]
    pub fn tptc_a0_read_access_error(&mut self) -> TptcA0ReadAccessErrorW<MssTpccAErraggMaskSpec> {
...
Mask Error from MSS_TPTC_A1 to aggregated Error MSS_TPCC_A_ERRAGG 1 : Error is Masked 0 : Error is Unmasked"]
    #[inline(always)]
    #[must_use]
    pub fn tptc_a1_read_access_error(&mut self) -> TptcA1ReadAccessErrorW<MssTpccAErraggMaskSpec> {
        TptcA1ReadAccessErrorW::new(self, 26)
    }
}
#[doc = "MSS_TPCC_A_ERRAGG_MASK\n\nYou can [`read`](crate::Reg::read) this register and get [`mss_tpcc_a_erragg_mask::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mss_tpcc_a_erragg_mask::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MssTpccAErraggMaskSpec;
impl crate::RegisterSpec for MssTpccAErraggMaskSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mss_tpcc_a_erragg_mask::R`](R) reader structure"]
impl crate::Readable for MssTpccAErraggMaskSpec {}
#[doc = "`write(|w| ..)` method takes [`mss_tpcc_a_erragg_mask::W`](W) writer structure"]
impl crate::Writable for MssTpccAErraggMaskSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MSS_TPCC_A_ERRAGG_MASK to value 0"]
impl crate::Resettable for MssTpccAErraggMaskSpec {
