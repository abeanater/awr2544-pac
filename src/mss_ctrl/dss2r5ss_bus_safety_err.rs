#[doc = "Register `DSS2R5SS_BUS_SAFETY_ERR` reader"]
pub type R = crate::R<Dss2r5ssBusSafetyErrSpec>;
#[doc = "Register `DSS2R5SS_BUS_SAFETY_ERR` writer"]
pub type W = crate::W<Dss2r5ssBusSafetyErrSpec>;
...
Refer to 25xx Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn comp_err(&mut self) -> CompErrW<Dss2r5ssBusSafetyErrSpec> {
        CompErrW::new(self, 0)
    }
    #[doc = "Bits 8:15 - 15:8\\]
Refer to 25xx Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn comp_check(&mut self) -> CompCheckW<Dss2r5ssBusSafetyErrSpec> {
...
Refer to 25xx Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn sec(&mut self) -> SecW<Dss2r5ssBusSafetyErrSpec> {
        SecW::new(self, 16)
    }
    #[doc = "Bits 24:31 - 31:24\\]
Refer to 25xx Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn ded(&mut self) -> DedW<Dss2r5ssBusSafetyErrSpec> {
        DedW::new(self, 24)
    }
}
#[doc = "DSS2R5SS_BUS_SAFETY_ERR\n\nYou can [`read`](crate::Reg::read) this register and get [`dss2r5ss_bus_safety_err::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dss2r5ss_bus_safety_err::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Dss2r5ssBusSafetyErrSpec;
impl crate::RegisterSpec for Dss2r5ssBusSafetyErrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dss2r5ss_bus_safety_err::R`](R) reader structure"]
impl crate::Readable for Dss2r5ssBusSafetyErrSpec {}
#[doc = "`write(|w| ..)` method takes [`dss2r5ss_bus_safety_err::W`](W) writer structure"]
impl crate::Writable for Dss2r5ssBusSafetyErrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DSS2R5SS_BUS_SAFETY_ERR to value 0"]
impl crate::Resettable for Dss2r5ssBusSafetyErrSpec {
