#[doc = "Register `MSS_TPCC_A_ERRAGG_STATUS` reader"]
pub type R = crate::R<MssTpccAErraggStatusSpec>;
#[doc = "Register `MSS_TPCC_A_ERRAGG_STATUS` writer"]
pub type W = crate::W<MssTpccAErraggStatusSpec>;
#[doc = "Field `tpcc_a_errint` reader - 0:0\\]
Status of Error from MSS_TPCC_A. Set only if Interupt is unmasked in MSS_TPCC_A_ERRAGG_MASK Wrie 0x1 to clear this Error."]
...
Status of Error from MSS_TPTC_A0. Set only if Interupt is unmasked in MSS_TPCC_A_ERRAGG_MASK Wrie 0x1 to clear this Error."]
...
Status of Error from MSS_TPTC_A1. Set only if Interupt is unmasked in MSS_TPCC_A_ERRAGG_MASK Wrie 0x1 to clear this Error."]
...
Status of Error from MSS_TPCC_A. Set only if Interupt is unmasked in MSS_TPCC_A_ERRAGG_MASK Wrie 0x1 to clear this Error."]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_errint(&mut self) -> TpccAErrintW<MssTpccAErraggStatusSpec> {
...
Status of Error from MSS_TPCC_A. Set only if Interupt is unmasked in MSS_TPCC_A_ERRAGG_MASK Wrie 0x1 to clear this Error."]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_mpint(&mut self) -> TpccAMpintW<MssTpccAErraggStatusSpec> {
...
Status of Error from MSS_TPTC_A0. Set only if Interupt is unmasked in MSS_TPCC_A_ERRAGG_MASK Wrie 0x1 to clear this Error."]
    #[inline(always)]
    #[must_use]
    pub fn tptc_a0_err(&mut self) -> TptcA0ErrW<MssTpccAErraggStatusSpec> {
...
Status of Error from MSS_TPTC_A1. Set only if Interupt is unmasked in MSS_TPCC_A_ERRAGG_MASK Wrie 0x1 to clear this Error."]
    #[inline(always)]
    #[must_use]
    pub fn tptc_a1_err(&mut self) -> TptcA1ErrW<MssTpccAErraggStatusSpec> {
...
Status of Error from MSS_TPCC_A. Set only if Interupt is unmasked in MSS_TPCC_A_ERRAGG_MASK Wrie 0x1 to clear this Error."]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_par_err(&mut self) -> TpccAParErrW<MssTpccAErraggStatusSpec> {
...
Status of Error from MSS_TPCC_A. Set only if Interupt is unmasked in MSS_TPCC_A_ERRAGG_MASK Wrie 0x1 to clear this Error."]
    ...
    pub fn tpcc_a_write_access_error(
        &mut self,
    ) -> TpccAWriteAccessErrorW<MssTpccAErraggStatusSpec> {
...
Status of Error from MSS_TPTC_A0. Set only if Interupt is unmasked in MSS_TPCC_A_ERRAGG_MASK Wrie 0x1 to clear this Error."]
    ...
    pub fn tptc_a0_write_access_error(
        &mut self,
    ) -> TptcA0WriteAccessErrorW<MssTpccAErraggStatusSpec> {
...
Status of Error from MSS_TPTC_A1. Set only if Interupt is unmasked in MSS_TPCC_A_ERRAGG_MASK Wrie 0x1 to clear this Error."]
    ...
    pub fn tptc_a1_write_access_error(
        &mut self,
    ) -> TptcA1WriteAccessErrorW<MssTpccAErraggStatusSpec> {
...
Status of Error from MSS_TPCC_A. Set only if Interupt is unmasked in MSS_TPCC_A_ERRAGG_MASK Wrie 0x1 to clear this Error."]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_read_access_error(&mut self) -> TpccAReadAccessErrorW<MssTpccAErraggStatusSpec> {
...
Status of Error from MSS_TPTC_A0. Set only if Interupt is unmasked in MSS_TPCC_A_ERRAGG_MASK Wrie 0x1 to clear this Error."]
    ...
    pub fn tptc_a0_read_access_error(
        &mut self,
    ) -> TptcA0ReadAccessErrorW<MssTpccAErraggStatusSpec> {
...
Status of Error from MSS_TPTC_A1. Set only if Interupt is unmasked in MSS_TPCC_A_ERRAGG_MASK Wrie 0x1 to clear this Error."]
    ...
    pub fn tptc_a1_read_access_error(
        &mut self,
    ) -> TptcA1ReadAccessErrorW<MssTpccAErraggStatusSpec> {
...
pub struct MssTpccAErraggStatusSpec;
impl crate::RegisterSpec for MssTpccAErraggStatusSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mss_tpcc_a_erragg_status::R`](R) reader structure"]
impl crate::Readable for MssTpccAErraggStatusSpec {}
#[doc = "`write(|w| ..)` method takes [`mss_tpcc_a_erragg_status::W`](W) writer structure"]
impl crate::Writable for MssTpccAErraggStatusSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MSS_TPCC_A_ERRAGG_STATUS to value 0"]
impl crate::Resettable for MssTpccAErraggStatusSpec {
