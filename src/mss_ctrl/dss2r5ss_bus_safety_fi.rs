#[doc = "Register `DSS2R5SS_BUS_SAFETY_FI` reader"]
pub type R = crate::R<Dss2r5ssBusSafetyFiSpec>;
#[doc = "Register `DSS2R5SS_BUS_SAFETY_FI` writer"]
pub type W = crate::W<Dss2r5ssBusSafetyFiSpec>;
...
Refer to 25xx Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn global_main(&mut self) -> GlobalMainW<Dss2r5ssBusSafetyFiSpec> {
...
Refer to 25xx Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn global_safe(&mut self) -> GlobalSafeW<Dss2r5ssBusSafetyFiSpec> {
...
Refer to 25xx Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn global_main_req(&mut self) -> GlobalMainReqW<Dss2r5ssBusSafetyFiSpec> {
...
Refer to 25xx Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn global_safe_req(&mut self) -> GlobalSafeReqW<Dss2r5ssBusSafetyFiSpec> {
...
Refer to 25xx Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn sec(&mut self) -> SecW<Dss2r5ssBusSafetyFiSpec> {
        SecW::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
Refer to 25xx Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn ded(&mut self) -> DedW<Dss2r5ssBusSafetyFiSpec> {
        DedW::new(self, 5)
    }
    #[doc = "Bits 8:15 - 15:8\\]
Refer to 25xx Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn data(&mut self) -> DataW<Dss2r5ssBusSafetyFiSpec> {
        DataW::new(self, 8)
    }
    #[doc = "Bits 16:23 - 23:16\\]
Refer to 25xx Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn main(&mut self) -> MainW<Dss2r5ssBusSafetyFiSpec> {
        MainW::new(self, 16)
    }
    #[doc = "Bits 24:31 - 31:24\\]
Refer to 25xx Substem Microarch document for more details"]
    #[inline(always)]
    #[must_use]
    pub fn safe(&mut self) -> SafeW<Dss2r5ssBusSafetyFiSpec> {
        SafeW::new(self, 24)
    }
}
#[doc = "DSS2R5SS_BUS_SAFETY_FI\n\nYou can [`read`](crate::Reg::read) this register and get [`dss2r5ss_bus_safety_fi::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dss2r5ss_bus_safety_fi::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Dss2r5ssBusSafetyFiSpec;
impl crate::RegisterSpec for Dss2r5ssBusSafetyFiSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dss2r5ss_bus_safety_fi::R`](R) reader structure"]
impl crate::Readable for Dss2r5ssBusSafetyFiSpec {}
#[doc = "`write(|w| ..)` method takes [`dss2r5ss_bus_safety_fi::W`](W) writer structure"]
impl crate::Writable for Dss2r5ssBusSafetyFiSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DSS2R5SS_BUS_SAFETY_FI to value 0"]
impl crate::Resettable for Dss2r5ssBusSafetyFiSpec {
