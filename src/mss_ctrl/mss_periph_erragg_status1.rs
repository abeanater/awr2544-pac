#[doc = "Register `MSS_PERIPH_ERRAGG_STATUS1` reader"]
pub type R = crate::R<MssPeriphErraggStatus1Spec>;
#[doc = "Register `MSS_PERIPH_ERRAGG_STATUS1` writer"]
pub type W = crate::W<MssPeriphErraggStatus1Spec>;
#[doc = "Field `mpu_rd_mss_l2_banka` reader - 0:0\\]
Status of Interrupt from MPU_MSS_L2_BANKA Set only if Interupt is unmasked in MSS_PERIPH_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
...
Status of Interrupt from MPU_MSS_L2_BANKB Set only if Interupt is unmasked in MSS_PERIPH_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
...
Status of Interrupt from MPU_HSM_DTHE Set only if Interupt is unmasked in MSS_PERIPH_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
...
Status of Interrupt from MPU_MSS_MBOX Set only if Interupt is unmasked in MSS_PERIPH_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
...
Status of Interrupt from MPU_MSS_PCRA Set only if Interupt is unmasked in MSS_PERIPH_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
...
Status of Interrupt from MPU_MSS_QSPI Set only if Interupt is unmasked in MSS_PERIPH_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
...
Status of Interrupt from MPU_MSS_CR5A_AXIS Set only if Interupt is unmasked in MSS_PERIPH_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
...
Status of Interrupt from MPU_MSS_L2_BANKC Set only if Interupt is unmasked in MSS_PERIPH_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
...
Status of Interrupt from MPU_DSS_L3_BANKA Set only if Interupt is unmasked in MSS_PERIPH_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
...
Status of Interrupt from MPU_DSS_L3_BANKB Set only if Interupt is unmasked in MSS_PERIPH_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
...
Status of Interrupt from MPU_DSS_MBOX Set only if Interupt is unmasked in MSS_PERIPH_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
...
Status of Interrupt from MPU_HSM Set only if Interupt is unmasked in MSS_PERIPH_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
...
Status of Interrupt from MPU_MSS_L2_BANKA Set only if Interupt is unmasked in MSS_PERIPH_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn mpu_rd_mss_l2_banka(&mut self) -> MpuRdMssL2BankaW<MssPeriphErraggStatus1Spec> {
...
Status of Interrupt from MPU_MSS_L2_BANKB Set only if Interupt is unmasked in MSS_PERIPH_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn mpu_rd_mss_l2_bankb(&mut self) -> MpuRdMssL2BankbW<MssPeriphErraggStatus1Spec> {
...
Status of Interrupt from MPU_HSM_DTHE Set only if Interupt is unmasked in MSS_PERIPH_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn mpu_rd_hsm_dthe(&mut self) -> MpuRdHsmDtheW<MssPeriphErraggStatus1Spec> {
...
Status of Interrupt from MPU_MSS_MBOX Set only if Interupt is unmasked in MSS_PERIPH_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn mpu_rd_mss_mbox(&mut self) -> MpuRdMssMboxW<MssPeriphErraggStatus1Spec> {
...
Status of Interrupt from MPU_MSS_PCRA Set only if Interupt is unmasked in MSS_PERIPH_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn mpu_rd_mss_pcra(&mut self) -> MpuRdMssPcraW<MssPeriphErraggStatus1Spec> {
...
Status of Interrupt from MPU_MSS_QSPI Set only if Interupt is unmasked in MSS_PERIPH_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn mpu_rd_mss_qspi(&mut self) -> MpuRdMssQspiW<MssPeriphErraggStatus1Spec> {
...
Status of Interrupt from MPU_MSS_CR5A_AXIS Set only if Interupt is unmasked in MSS_PERIPH_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn mpu_rd_mss_cr5a_axis(&mut self) -> MpuRdMssCr5aAxisW<MssPeriphErraggStatus1Spec> {
...
Status of Interrupt from MPU_MSS_L2_BANKC Set only if Interupt is unmasked in MSS_PERIPH_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn mpu_rd_mss_cr5b_axis(&mut self) -> MpuRdMssCr5bAxisW<MssPeriphErraggStatus1Spec> {
...
Status of Interrupt from MPU_DSS_L3_BANKA Set only if Interupt is unmasked in MSS_PERIPH_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn mpu_rd_dss_l3_banka(&mut self) -> MpuRdDssL3BankaW<MssPeriphErraggStatus1Spec> {
...
Status of Interrupt from MPU_DSS_L3_BANKB Set only if Interupt is unmasked in MSS_PERIPH_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn mpu_rd_dss_l3_bankb(&mut self) -> MpuRdDssL3BankbW<MssPeriphErraggStatus1Spec> {
...
RESERVED:Dont Use"]
    #[inline(always)]
    #[must_use]
    pub fn mpu_rd_dss_l3_bankc(&mut self) -> MpuRdDssL3BankcW<MssPeriphErraggStatus1Spec> {
...
RESERVED:Dont Use"]
    #[inline(always)]
    #[must_use]
    pub fn mpu_rd_dss_l3_bankd(&mut self) -> MpuRdDssL3BankdW<MssPeriphErraggStatus1Spec> {
...
RESERVED:Dont Use"]
    #[inline(always)]
    #[must_use]
    pub fn mpu_rd_dss_hwa_dma0(&mut self) -> MpuRdDssHwaDma0W<MssPeriphErraggStatus1Spec> {
...
RESERVED:Dont Use"]
    #[inline(always)]
    #[must_use]
    pub fn mpu_rd_dss_hwa_dma1(&mut self) -> MpuRdDssHwaDma1W<MssPeriphErraggStatus1Spec> {
...
RESERVED:Dont Use"]
    #[inline(always)]
    #[must_use]
    pub fn mpu_rd_dss_hwa_proc(&mut self) -> MpuRdDssHwaProcW<MssPeriphErraggStatus1Spec> {
...
Status of Interrupt from MPU_DSS_MBOX Set only if Interupt is unmasked in MSS_PERIPH_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn mpu_rd_dss_mbox(&mut self) -> MpuRdDssMboxW<MssPeriphErraggStatus1Spec> {
...
Status of Interrupt from MPU_HSM Set only if Interupt is unmasked in MSS_PERIPH_ERRAGG_MASK1 Wrie 0x1 to clear this interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn mpu_rd_hsm(&mut self) -> MpuRdHsmW<MssPeriphErraggStatus1Spec> {
        MpuRdHsmW::new(self, 16)
    }
}
#[doc = "MSS_PERIPH_ERRAGG_STATUS1\n\nYou can [`read`](crate::Reg::read) this register and get [`mss_periph_erragg_status1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mss_periph_erragg_status1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MssPeriphErraggStatus1Spec;
impl crate::RegisterSpec for MssPeriphErraggStatus1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mss_periph_erragg_status1::R`](R) reader structure"]
impl crate::Readable for MssPeriphErraggStatus1Spec {}
#[doc = "`write(|w| ..)` method takes [`mss_periph_erragg_status1::W`](W) writer structure"]
impl crate::Writable for MssPeriphErraggStatus1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MSS_PERIPH_ERRAGG_STATUS1 to value 0"]
impl crate::Resettable for MssPeriphErraggStatus1Spec {
