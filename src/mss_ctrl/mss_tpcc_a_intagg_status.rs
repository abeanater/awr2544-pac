#[doc = "Register `MSS_TPCC_A_INTAGG_STATUS` reader"]
pub type R = crate::R<MssTpccAIntaggStatusSpec>;
#[doc = "Register `MSS_TPCC_A_INTAGG_STATUS` writer"]
pub type W = crate::W<MssTpccAIntaggStatusSpec>;
#[doc = "Field `tpcc_a_intg` reader - 0:0\\]
Status of Interrupt from MSS_TPCC_A. Set only if Interupt is unmasked in MSS_TPCC_A_INTAGG_MASK Wrie 0x1 to clear this interrupt."]
...
Status of Interrupt from TPCC A Set only if Interupt is unmasked in MSS_TPCC_A_INTAGG_MASK Wrie 0x1 to clear this interrupt."]
...
Status of Interrupt from TPTC A0. Set only if Interupt is unmasked in MSS_TPCC_A_INTAGG_MASK Wrie 0x1 to clear this interrupt."]
...
Status of Interrupt from TPTC A1. Set only if Interupt is unmasked in MSS_TPCC_A_INTAGG_MASK Wrie 0x1 to clear this interrupt."]
...
Status of Interrupt from MSS_TPCC_A. Set only if Interupt is unmasked in MSS_TPCC_A_INTAGG_MASK Wrie 0x1 to clear this interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_intg(&mut self) -> TpccAIntgW<MssTpccAIntaggStatusSpec> {
...
Status of Interrupt from TPCC A Set only if Interupt is unmasked in MSS_TPCC_A_INTAGG_MASK Wrie 0x1 to clear this interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_int0(&mut self) -> TpccAInt0W<MssTpccAIntaggStatusSpec> {
...
Status of Interrupt from MSS_TPCC_A. Set only if Interupt is unmasked in MSS_TPCC_A_INTAGG_MASK Wrie 0x1 to clear this interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_int1(&mut self) -> TpccAInt1W<MssTpccAIntaggStatusSpec> {
...
Status of Interrupt from MSS_TPCC_A. Set only if Interupt is unmasked in MSS_TPCC_A_INTAGG_MASK Wrie 0x1 to clear this interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_int2(&mut self) -> TpccAInt2W<MssTpccAIntaggStatusSpec> {
...
Status of Interrupt from MSS_TPCC_A. Set only if Interupt is unmasked in MSS_TPCC_A_INTAGG_MASK Wrie 0x1 to clear this interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_int3(&mut self) -> TpccAInt3W<MssTpccAIntaggStatusSpec> {
...
Status of Interrupt from MSS_TPCC_A. Set only if Interupt is unmasked in MSS_TPCC_A_INTAGG_MASK Wrie 0x1 to clear this interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_int4(&mut self) -> TpccAInt4W<MssTpccAIntaggStatusSpec> {
...
Status of Interrupt from MSS_TPCC_A. Set only if Interupt is unmasked in MSS_TPCC_A_INTAGG_MASK Wrie 0x1 to clear this interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_int5(&mut self) -> TpccAInt5W<MssTpccAIntaggStatusSpec> {
...
Status of Interrupt from MSS_TPCC_A. Set only if Interupt is unmasked in MSS_TPCC_A_INTAGG_MASK Wrie 0x1 to clear this interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_int6(&mut self) -> TpccAInt6W<MssTpccAIntaggStatusSpec> {
...
Status of Interrupt from MSS_TPCC_A. Set only if Interupt is unmasked in MSS_TPCC_A_INTAGG_MASK Wrie 0x1 to clear this interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_int7(&mut self) -> TpccAInt7W<MssTpccAIntaggStatusSpec> {
...
Status of Interrupt from TPTC A0. Set only if Interupt is unmasked in MSS_TPCC_A_INTAGG_MASK Wrie 0x1 to clear this interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn tptc_a0(&mut self) -> TptcA0W<MssTpccAIntaggStatusSpec> {
        TptcA0W::new(self, 16)
    }
    #[doc = "Bit 17 - 17:17\\]
Status of Interrupt from TPTC A1. Set only if Interupt is unmasked in MSS_TPCC_A_INTAGG_MASK Wrie 0x1 to clear this interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn tptc_a1(&mut self) -> TptcA1W<MssTpccAIntaggStatusSpec> {
        TptcA1W::new(self, 17)
    }
}
#[doc = "MSS_TPCC_A_INTAGG_STATUS\n\nYou can [`read`](crate::Reg::read) this register and get [`mss_tpcc_a_intagg_status::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mss_tpcc_a_intagg_status::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MssTpccAIntaggStatusSpec;
impl crate::RegisterSpec for MssTpccAIntaggStatusSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mss_tpcc_a_intagg_status::R`](R) reader structure"]
impl crate::Readable for MssTpccAIntaggStatusSpec {}
#[doc = "`write(|w| ..)` method takes [`mss_tpcc_a_intagg_status::W`](W) writer structure"]
impl crate::Writable for MssTpccAIntaggStatusSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MSS_TPCC_A_INTAGG_STATUS to value 0"]
impl crate::Resettable for MssTpccAIntaggStatusSpec {
