#[doc = "Register `MSS_TPCC_A_ERRAGG_STATUS_RAW` reader"]
pub type R = crate::R<MssTpccAErraggStatusRawSpec>;
#[doc = "Register `MSS_TPCC_A_ERRAGG_STATUS_RAW` writer"]
pub type W = crate::W<MssTpccAErraggStatusRawSpec>;
#[doc = "Field `tpcc_a_errint` reader - 0:0\\]
Raw Status of Error from MSS_TPCC_A. Set irrespective if the Interupt is masked or unmasked in MSS_TPCC_A_ERRAGG_MASK"]
...
Raw Status of Error from MSS_TPTC_A0. Set irrespective if the Interupt is masked or unmasked in MSS_TPCC_A_ERRAGG_MASK"]
...
Raw Status of Error from MSS_TPTC_A1. Set irrespective if the Interupt is masked or unmasked in MSS_TPCC_A_ERRAGG_MASK"]
...
Raw Status of Error from MSS_TPCC_A. Set irrespective if the Interupt is masked or unmasked in MSS_TPCC_A_ERRAGG_MASK"]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_errint(&mut self) -> TpccAErrintW<MssTpccAErraggStatusRawSpec> {
...
Raw Status of Error from MSS_TPCC_A. Set irrespective if the Interupt is masked or unmasked in MSS_TPCC_A_ERRAGG_MASK"]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_mpint(&mut self) -> TpccAMpintW<MssTpccAErraggStatusRawSpec> {
...
Raw Status of Error from MSS_TPTC_A0. Set irrespective if the Interupt is masked or unmasked in MSS_TPCC_A_ERRAGG_MASK"]
    #[inline(always)]
    #[must_use]
    pub fn tptc_a0_err(&mut self) -> TptcA0ErrW<MssTpccAErraggStatusRawSpec> {
...
Raw Status of Error from MSS_TPTC_A1. Set irrespective if the Interupt is masked or unmasked in MSS_TPCC_A_ERRAGG_MASK"]
    #[inline(always)]
    #[must_use]
    pub fn tptc_a1_err(&mut self) -> TptcA1ErrW<MssTpccAErraggStatusRawSpec> {
...
Raw Status of Error from MSS_TPCC_A. Set irrespective if the Interupt is masked or unmasked in MSS_TPCC_A_ERRAGG_MASK"]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_par_err(&mut self) -> TpccAParErrW<MssTpccAErraggStatusRawSpec> {
...
Raw Status of Error from MSS_TPCC_A. Set irrespective if the Interupt is masked or unmasked in MSS_TPCC_A_ERRAGG_MASK"]
    ...
    pub fn tpcc_a_write_access_error(
        &mut self,
    ) -> TpccAWriteAccessErrorW<MssTpccAErraggStatusRawSpec> {
...
Raw Status of Error from MSS_TPTC_A0. Set irrespective if the Interupt is masked or unmasked in MSS_TPCC_A_ERRAGG_MASK"]
    ...
    pub fn tptc_a0_write_access_error(
        &mut self,
    ) -> TptcA0WriteAccessErrorW<MssTpccAErraggStatusRawSpec> {
...
Raw Status of Error from MSS_TPTC_A1. Set irrespective if the Interupt is masked or unmasked in MSS_TPCC_A_ERRAGG_MASK"]
    ...
    pub fn tptc_a1_write_access_error(
        &mut self,
    ) -> TptcA1WriteAccessErrorW<MssTpccAErraggStatusRawSpec> {
...
Raw Status of Error from MSS_TPCC_A. Set irrespective if the Interupt is masked or unmasked in MSS_TPCC_A_ERRAGG_MASK"]
    ...
    pub fn tpcc_a_read_access_error(
        &mut self,
    ) -> TpccAReadAccessErrorW<MssTpccAErraggStatusRawSpec> {
...
Raw Status of Error from MSS_TPTC_A0. Set irrespective if the Interupt is masked or unmasked in MSS_TPCC_A_ERRAGG_MASK"]
    ...
    pub fn tptc_a0_read_access_error(
        &mut self,
    ) -> TptcA0ReadAccessErrorW<MssTpccAErraggStatusRawSpec> {
...
Raw Status of Error from MSS_TPTC_A1. Set irrespective if the Interupt is masked or unmasked in MSS_TPCC_A_ERRAGG_MASK"]
    ...
    pub fn tptc_a1_read_access_error(
        &mut self,
    ) -> TptcA1ReadAccessErrorW<MssTpccAErraggStatusRawSpec> {
        TptcA1ReadAccessErrorW::new(self, 26)
    }
}
#[doc = "MSS_TPCC_A_ERRAGG_STATUS_RAW\n\nYou can [`read`](crate::Reg::read) this register and get [`mss_tpcc_a_erragg_status_raw::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mss_tpcc_a_erragg_status_raw::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MssTpccAErraggStatusRawSpec;
impl crate::RegisterSpec for MssTpccAErraggStatusRawSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mss_tpcc_a_erragg_status_raw::R`](R) reader structure"]
impl crate::Readable for MssTpccAErraggStatusRawSpec {}
#[doc = "`write(|w| ..)` method takes [`mss_tpcc_a_erragg_status_raw::W`](W) writer structure"]
impl crate::Writable for MssTpccAErraggStatusRawSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MSS_TPCC_A_ERRAGG_STATUS_RAW to value 0"]
impl crate::Resettable for MssTpccAErraggStatusRawSpec {
