#[doc = "Register `RSS_TPCC_A_ERRAGG_STATUS` reader"]
pub type R = crate::R<RssTpccAErraggStatusSpec>;
#[doc = "Register `RSS_TPCC_A_ERRAGG_STATUS` writer"]
pub type W = crate::W<RssTpccAErraggStatusSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_errint(&mut self) -> TpccAErrintW<RssTpccAErraggStatusSpec> {
        TpccAErrintW::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_mpint(&mut self) -> TpccAMpintW<RssTpccAErraggStatusSpec> {
        TpccAMpintW::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn tptc_a0_err(&mut self) -> TptcA0ErrW<RssTpccAErraggStatusSpec> {
        TptcA0ErrW::new(self, 2)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_parity_err(&mut self) -> TpccAParityErrW<RssTpccAErraggStatusSpec> {
    ...
    pub fn tpcc_a_write_access_error(
        &mut self,
    ) -> TpccAWriteAccessErrorW<RssTpccAErraggStatusSpec> {
    ...
    pub fn tptc_a0_write_access_error(
        &mut self,
    ) -> TptcA0WriteAccessErrorW<RssTpccAErraggStatusSpec> {
        TptcA0WriteAccessErrorW::new(self, 17)
    }
    #[doc = "Bit 24"]
    #[inline(always)]
    #[must_use]
    pub fn tpcc_a_read_access_error(&mut self) -> TpccAReadAccessErrorW<RssTpccAErraggStatusSpec> {
    ...
    pub fn tptc_a0_read_access_error(
        &mut self,
    ) -> TptcA0ReadAccessErrorW<RssTpccAErraggStatusSpec> {
        TptcA0ReadAccessErrorW::new(self, 25)
    }
}
#[doc = "RSS_TPCC_A_ERRAGG_STATUS\n\nYou can [`read`](crate::Reg::read) this register and get [`rss_tpcc_a_erragg_status::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rss_tpcc_a_erragg_status::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RssTpccAErraggStatusSpec;
impl crate::RegisterSpec for RssTpccAErraggStatusSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rss_tpcc_a_erragg_status::R`](R) reader structure"]
impl crate::Readable for RssTpccAErraggStatusSpec {}
#[doc = "`write(|w| ..)` method takes [`rss_tpcc_a_erragg_status::W`](W) writer structure"]
impl crate::Writable for RssTpccAErraggStatusSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets RSS_TPCC_A_ERRAGG_STATUS to value 0"]
impl crate::Resettable for RssTpccAErraggStatusSpec {
