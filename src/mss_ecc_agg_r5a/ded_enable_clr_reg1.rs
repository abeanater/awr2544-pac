#[doc = "Register `ded_enable_clr_reg1` reader"]
...
#[doc = "Interrupt Enable Clear Register 1\n\nYou can [`read`](crate::Reg::read) this register and get [`ded_enable_clr_reg1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ded_enable_clr_reg1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DedEnableClrReg1Spec;
impl crate::RegisterSpec for DedEnableClrReg1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ded_enable_clr_reg1::R`](R) reader structure"]
impl crate::Readable for DedEnableClrReg1Spec {}
#[doc = "`write(|w| ..)` method takes [`ded_enable_clr_reg1::W`](W) writer structure"]
impl crate::Writable for DedEnableClrReg1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ded_enable_clr_reg1 to value 0"]
impl crate::Resettable for DedEnableClrReg1Spec {
