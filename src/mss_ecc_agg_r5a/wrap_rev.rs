#[doc = "Register `wrap_rev` reader"]
pub type R = crate::R<WrapRevSpec>;
#[doc = "Register `wrap_rev` writer"]
pub type W = crate::W<WrapRevSpec>;
...
Minor version"]
    #[inline(always)]
    #[must_use]
    pub fn minor_version(&mut self) -> MinorVersionW<WrapRevSpec> {
...
Custom version"]
    #[inline(always)]
    #[must_use]
    pub fn custom_version(&mut self) -> CustomVersionW<WrapRevSpec> {
...
Major version"]
    #[inline(always)]
    #[must_use]
    pub fn major_version(&mut self) -> MajorVersionW<WrapRevSpec> {
...
RTL version"]
    #[inline(always)]
    #[must_use]
    pub fn rtl_version(&mut self) -> RtlVersionW<WrapRevSpec> {
...
Module ID"]
    #[inline(always)]
    #[must_use]
    pub fn module_id(&mut self) -> ModuleIdW<WrapRevSpec> {
...
bu"]
    #[inline(always)]
    #[must_use]
    pub fn bu(&mut self) -> BuW<WrapRevSpec> {
        BuW::new(self, 28)
    }
    #[doc = "Bits 30:31 - 31:30\\]
Scheme"]
    #[inline(always)]
    #[must_use]
    pub fn scheme(&mut self) -> SchemeW<WrapRevSpec> {
        SchemeW::new(self, 30)
    }
}
#[doc = "Revision parameters\n\nYou can [`read`](crate::Reg::read) this register and get [`wrap_rev::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`wrap_rev::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct WrapRevSpec;
impl crate::RegisterSpec for WrapRevSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`wrap_rev::R`](R) reader structure"]
impl crate::Readable for WrapRevSpec {}
#[doc = "`write(|w| ..)` method takes [`wrap_rev::W`](W) writer structure"]
impl crate::Writable for WrapRevSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets wrap_rev to value 0"]
impl crate::Resettable for WrapRevSpec {
